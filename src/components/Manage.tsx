        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-5xl font-sans text-slate-900 mb-6">
              Manage appointments, treatments, and client journeys
            </h2>
            <p className="text-lg text-slate-600">
              Allow clients to book treatments, consultations, and packages
              online with ease.{" "}
            </p>
          </div>
            ...
            <div className="md:col-span-5 bg-slate-900 rounded-2xl p-8 shadow-xl text-white relative overflow-hidden">
              ...
              <div className="space-y-4 mb-8">
                <div className="flex justify-between items-center border-b border-slate-700 pb-4">
                  <span className="text-slate-400">Aesthetic Consultation</span>
