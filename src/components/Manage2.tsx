        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-5xl font-sans text-slate-900 mb-6">
              Manage consultations, follow-ups, and treatment plans
            </h2>
            <p className="text-lg text-slate-600">
              Enable patients to book dermatology consultations, follow-ups, and
              ongoing treatment sessions seamlessly.{" "}
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
            ...
            <div className="md:col-span-5 bg-slate-900 rounded-2xl p-8 shadow-xl text-white relative overflow-hidden">
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex justify-between items-center border-b border-slate-700 pb-4">
                  <span className="text-slate-400">Dermatology Procedure</span>
