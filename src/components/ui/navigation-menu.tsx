  ...
  return (
    <NavigationMenuPrimitive.Content
      ...
      className={cn(
        ...
        "md:fixed md:left-0 md:right-0 md:w-screen md:max-w-none",
        "md:rounded-none md:shadow-lg",
  ...
  return (
    ...
    >
      <NavigationMenuPrimitive.Viewport
        ...
        className={cn(
          "origin-top-center relative mt-1.5 h-(--radix-navigation-menu-viewport-height) w-full overflow-hidden rounded-lg bg-popover text-popover-foreground shadow ring-1 ring-foreground/10 duration-100 md:w-screen md:max-w-none md:rounded-none data-open:animate-in data-open:zoom-in-90 data-closed:animate-out data-closed:zoom-out-90",
          className
        )}
        {...props}
      />
