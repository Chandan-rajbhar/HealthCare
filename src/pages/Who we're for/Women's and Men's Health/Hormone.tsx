...
const portalFeatures: PortalFeature[] = [
  ...
  {
    title: "Build and track personalised hormone therapy protocols",
    desc: "Create structured HRT protocols for each patient. Every dosage review and lab check-in is tracked automatically with clear visibility into progress and adjustments.",
    icon: ClipboardList,
  },
  {
    title: "Manage recurring treatments and dosage reviews with ease",
    desc: "Set up ongoing hormone therapy programs with automated billing and medication reminders, so you never have to chase payments or missed reviews manually.",
    icon: Repeat,
  },
  {
    title: "Run group education sessions and wellness programs",
    desc: "Organise group hormone health programs, manage attendance, and handle registrations alongside individual consultations — all from one system.",
    icon: Users,
  },
  {
    title: "Give patients visibility into their therapy journey",
    desc: "Patients can view lab results, upcoming appointments, treatment notes, and shared resources — helping them stay engaged and consistent with their protocol.",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="max-w-2xl">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#009689]/10 border border-[#009689]/20 text-[#009689] text-sm font-semibold mb-6">
                ...
                Built for Hormone Therapy Clinics
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-slate-600">
              ...
              retention — all from a platform built specifically for hormone
              therapy clinics.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <h2 className="text-3xl md:text-4xl font-sans text-slate-900 mb-6">
                Comprehensive records for hormone therapy care
              </h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative h-[420px] hidden lg:block">
            ...
            <div className="absolute left-36 top-16 w-80 bg-slate-50 rounded-3xl border border-slate-200 shadow-lg p-6">
              ...
              <p className="text-slate-500 mb-6">Hormone Therapy Specialist</p>

              <div className="space-y-4 text-sm text-slate-600">
                <div>
                  <p className="text-xs uppercase">Service</p>
                  <p>HRT Consultation</p>
                </div>
          ...
          <div className="max-w-4xl mx-auto bg-slate-800 border border-slate-700 rounded-3xl p-8 md:p-12 text-center shadow-2xl">
            ...
            <div>
              ...
              <p className="text-[#009689] font-medium">
                Clinical Director, Vitalis Hormone Health Clinic
              </p>
            </div>
          </div>
        </div>
