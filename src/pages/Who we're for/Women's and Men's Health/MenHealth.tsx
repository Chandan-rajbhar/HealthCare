...
const faqs = [
  {
    question: "Is this software suitable for men's health clinics?",
    answer:
      "Yes, it is designed specifically for men's health clinics, supporting TRT, ED treatment, hair loss, weight management, and general men's health OPD workflows.",
  },
  {
    question: "Can I manage both chronic and acute men's health conditions?",
    answer:
      "Yes, you can manage ongoing treatment plans like hormone therapy alongside one-off consultations, diagnostics, and follow-ups in one unified system.",
  },
  {
    question: "Does it support hormone and lab tracking?",
    answer:
      "Yes, you can track hormone levels, lab results, and diagnostic trends over time alongside treatment plans and prescriptions.",
  },
  {
    question: "Can I handle prescriptions, lifestyle plans, and follow-ups?",
    answer:
      "Yes, the platform supports structured prescriptions, lifestyle and nutrition plans, automated follow-up reminders, and full patient history in one place.",
  },
];
type PortalFeature = {
  title: string;
...
const portalFeatures: PortalFeature[] = [
  ...
  },
  {
    ...
    desc: "Create structured care plans for TRT, ED, weight management, and hair loss. Each step is tracked automatically with clear visibility into progress and outcomes.",
    icon: ClipboardList,
  },
  {
    title: "Manage recurring care and medication schedules",
    desc: "Set up ongoing treatment programs with automated billing and medication reminders, so you never have to chase payments or missed doses manually.",
    icon: Repeat,
  },
  {
    title: "Run men's health programs and group consultations",
    desc: "Organise group health programs, manage attendance, and handle registrations alongside individual appointments — all from one system.",
    icon: Users,
  },
  {
    title: "Give patients visibility into their health journey",
    desc: "Patients can view consultation notes, upcoming appointments, lab results, and shared resources — helping them stay engaged and consistent with their treatment.",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="max-w-2xl">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#009689]/10 border border-[#009689]/20 text-[#009689] text-sm font-sans mb-6">
                ...
                Built for Men’s Health Clinics
              </div>
              <h1 className="text-4xl md:text-6xl font-sans tracking-tight leading-[1.1] mb-6">
                Advanced software for men’s health clinics.
              </h1>
              <p className="text-lg md:text-xl text-slate-300 mb-10 leading-relaxed">
                Manage consultations, treatments, diagnostics, and long-term
                care for men’s health — all in one unified platform built for
                modern clinics.{" "}
              </p>{" "}
          ...
          <div className="grid md:grid-cols-2 border border-slate-200 divide-y md:divide-y-0 md:divide-x divide-slate-200">
            ...
            <div className="p-12 bg-slate-50/50">
              ...
              <ul className="space-y-8">
                {[
                  "Patient history across consultations and treatments is fragmented",
                  "Tracking chronic conditions like ED, TRT, or hair loss is difficult",
                  "Follow-ups and treatment adherence are inconsistent",
                  "No clear visibility into diagnostics, prescriptions, and outcomes",
                ].map((item, i) => (
            ...
            <div className="p-12 bg-white">
              ...
              <ul className="space-y-8">
                {[
                  "Everything unified across men’s health workflows",
                  "Track consultations, diagnostics, and treatment plans",
                  "Automated reminders for medications, follow-ups, and lifestyle plans",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-5xl font-sans text-slate-900 mb-6">
              Everything you need to run and scale your men’s health clinic
            </h2>
            <p className="text-lg text-slate-600">
              Automate workflows, track treatment outcomes, and improve patient
              retention — all from a platform built specifically for men’s
              health clinics.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {[
              ...
              },
              {
                ...
                description:
                  "Track hormone levels, diagnostics, and treatment outcomes with structured timelines and clinical insights.",
                stat: "89%",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <h2 className="text-3xl md:text-4xl font-sans text-slate-900 mb-6">
                Comprehensive records for men's health care
              </h2>
              ...
              <ul className="space-y-5">
                {[
                  "Custom consultation forms for men's health conditions",
                  "Track hormone levels, diagnostics, and treatment plans",
                  "Monitor progress for ED, TRT, weight management, and hair loss",
                  "Maintain detailed prescriptions, lifestyle plans, and follow-ups",
                ].map((item, idx) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative h-[420px] hidden lg:block">
            ...
            <div className="absolute left-36 top-16 w-80 bg-slate-50 rounded-3xl border border-slate-200 shadow-lg p-6">
              ...
              <p className="text-slate-500 mb-6">Men's Health Specialist</p>

              <div className="space-y-4 text-sm text-slate-600">
                <div>
                  <p className="text-xs uppercase">Service</p>
                  <p>Men's Health Consultation</p>
                </div>
      ...
      <section className="bg-white py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-600">
              Common questions from men’s health clinic owners.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="max-w-4xl mx-auto bg-slate-800 border border-slate-700 rounded-3xl p-8 md:p-12 text-center shadow-2xl">
            ...
            <p className="text-2xl md:text-3xl leading-snug font-sans text-slate-200 mb-8 italic">
              "This platform has transformed how we manage men’s health care.
              From consultations to treatment plans and long-term follow-ups,
      ...
      <section className="bg-slate-900 py-24 border-t border-slate-800 relative overflow-hidden text-center">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <h2 className="text-4xl md:text-5xl font-sans text-white mb-6">
            Ready to modernize your men’s health clinic?
          </h2>

          <p className="text-xl text-slate-300 mb-10">
            Join leading men’s health clinics improving outcomes, enhancing
