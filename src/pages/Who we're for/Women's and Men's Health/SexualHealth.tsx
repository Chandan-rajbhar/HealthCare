...
const faqs = [
  {
    question: "Is this software suitable for sexual health clinics?",
    answer:
      "Yes, it is designed for sexual health clinics, supporting consultations, diagnostics, treatment plans, and long-term patient management.",
  },
  {
    question: "Can I manage sensitive patient data securely?",
    answer:
      "Yes, the platform is built with strong privacy controls and secure access to handle sensitive sexual health data safely.",
  },
  {
    question: "Does it support recurring treatments and follow-ups?",
    answer:
      "Yes, you can automate follow-ups, track treatment adherence, and manage long-term care plans efficiently.",
  },
  {
    question: "Can I manage diagnostics and prescriptions in one place?",
    answer:
      "Yes, labs, reports, prescriptions, and consultation notes are all unified in a single system.",
  },
];
...
const portalFeatures: PortalFeature[] = [
  {
    ...
    desc: "Patients can view your real-time availability and book consultations anytime. Automated SMS and email reminders reduce no-shows and keep your clinic running smoothly.",
    cta: "Discover Online Bookings",
    icon: CalendarCheck,
  },
  {
    title: "Build and track personalised treatment plans",
    desc: "Create structured care plans for STI management, PrEP, contraception, and ongoing conditions. Each step is tracked automatically with clear visibility into progress and outcomes.",
    icon: ClipboardList,
  },
  {
    title: "Manage recurring care and prescriptions with ease",
    desc: "Set up ongoing treatment programs with automated billing and prescription reminders, so you never have to chase payments or missed doses manually.",
    icon: Repeat,
  },
  {
    title: "Run group health programs and education sessions",
    desc: "Organise group sexual health programs, manage attendance, and handle registrations alongside individual appointments — all from one system.",
    icon: Users,
  },
  {
    title: "Give patients visibility into their health journey",
    desc: "Patients can view consultation notes, upcoming appointments, lab results, and shared resources — helping them stay engaged and consistent with their care.",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="max-w-2xl">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#009689]/10 border border-[#009689]/20 text-[#009689] text-sm font-semibold mb-6">
                ...
                Built for Sexual Health Clinics
              </div>
              <h1 className="text-4xl md:text-6xl font-sans tracking-tight leading-[1.1] mb-6">
                Advanced software for sexual health clinics.
              </h1>
              <p className="text-lg md:text-xl text-slate-300 mb-10 leading-relaxed">
                Manage consultations, diagnostics, treatments, and sensitive
                patient journeys — all in one unified platform built for modern
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mb-16">
            <h2 className="text-4xl md:text-5xl font-sans text-slate-900 leading-tight">
              Running a sexual health clinic
              <br />
          ...
          <div className="grid md:grid-cols-2 border border-slate-200 divide-y md:divide-y-0 md:divide-x divide-slate-200">
            ...
            <div className="p-12 bg-slate-50/50">
              ...
              <ul className="space-y-8">
                {[
                  "Sensitive patient data is scattered across systems",
                  "Tracking long-term conditions and treatment adherence is difficult",
                  "Follow-ups and patient engagement are inconsistent",
                  "No unified view of diagnostics, prescriptions, and outcomes",
                ].map((item, i) => (
            ...
            <div className="p-12 bg-white">
              ...
              <ul className="space-y-8">
                {[
                  "Everything unified across sexual health workflows",
                  "Track consultations, diagnostics, and treatment plans",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-5xl font-sans text-slate-900 mb-6">
              Everything you need to run and scale your sexual health clinic
            </h2>
            <p className="text-lg text-slate-600">
              Automate workflows, track treatment outcomes, and improve patient
              retention — all from a platform built specifically for sexual
              health clinics.
            </p>
          </div>
            ...
            {[
              {
                ...
                title: "Save time",
                description:
                  "Automate consultations, documentation, and follow-ups so your team can focus on patient care instead of manual coordination.",
                stat: "4.2 hrs",
              ...
              },
              {
                ...
                description:
                  "Track diagnostics, treatment progress, and outcomes with structured timelines and insights.",
                stat: "89%",
              ...
              },
              {
                ...
                title: "Grow revenue",
                description:
                  "Increase patient retention and treatment adherence with automated reminders and structured care plans.",
                stat: "3.1x",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                Capture every step of the patient journey — from first
                consultation to long-term treatment and follow-up care.
              </p>
              <ul className="space-y-5">
                {[
                  "Custom consultation forms for sexual health conditions",
                  "Track diagnostics, lab reports, and treatment plans",
                  "Monitor progress across ongoing treatments and therapies",
                  "Maintain detailed prescriptions and follow-ups",
                ].map((item, idx) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative h-[420px] hidden lg:block">
            ...
            <div className="absolute left-36 top-16 w-80 bg-slate-50 rounded-3xl border border-slate-200 shadow-lg p-6">
              ...
              <p className="text-slate-500 mb-6">Sexual Health Specialist</p>

              <div className="space-y-4 text-sm text-slate-600">
                <div>
                  <p className="text-xs uppercase">Service</p>
                  <p>Sexual Health Consultation</p>
                </div>
      ...
      <section className="bg-white py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-600">
              Common questions from sexual health clinic owners.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="max-w-4xl mx-auto bg-slate-800 border border-slate-700 rounded-3xl p-8 md:p-12 text-center shadow-2xl">
            ...
            <p className="text-2xl md:text-3xl leading-snug font-medium text-slate-200 mb-8 italic">
              "This platform has transformed how we manage sexual health care.
              From consultations to diagnostics and long-term follow-ups,
              everything is seamless, secure, and structured."
            </p>
            <div>
              <h4 className="font-sans text-xl text-white">Dr. Sarah Okafor</h4>
              <p className="text-[#009689] font-medium">
                Clinical Director, Viva Sexual Health Centre
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-slate-900 py-24 border-t border-slate-800 relative overflow-hidden text-center">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <h2 className="text-4xl md:text-5xl font-sans text-white mb-6">
            Ready to modernize your sexual health clinic?
          </h2>

          <p className="text-xl text-slate-300 mb-10">
            Join leading sexual health clinics improving outcomes, enhancing
