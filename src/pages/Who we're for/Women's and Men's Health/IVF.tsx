...
const faqs = [
  {
    question: "Is this software suitable for IVF and gynaecology clinics?",
    answer:
      "Yes, it is designed for IVF and gynaecology clinics, supporting fertility treatments, OPD workflows, and patient lifecycle management.",
  },
  {
    question: "Can I manage both fertility and general gynaecology patients?",
    answer:
      "Yes, you can manage IVF cycles as well as general gynaecology consultations, procedures, and follow-ups in one system.",
  },
  {
    question: "Does it support pregnancy and postnatal tracking?",
    answer:
      "Yes, you can track pregnancy progress, antenatal visits, and postnatal care alongside fertility treatments.",
  },
  {
    question: "Can I handle lab, scans, and prescriptions?",
    answer:
      "Yes, the platform supports lab workflows, ultrasound tracking, prescriptions, and reports in a unified system.",
  },
];
...
const portalFeatures: PortalFeature[] = [
  {
    ...
    desc: "Patients view real-time availability and book anytime. Automated SMS and email reminders reduce no-shows and keep your clinic schedule full.",
    cta: "Discover Online Bookings",
    icon: CalendarCheck,
  },
  {
    title: "Create and track complete IVF and gynaecology journeys",
    desc: "Build structured patient journeys covering consultation, stimulation, retrieval, transfer, and postnatal care. Each stage is tracked automatically with full visibility.",
    icon: ClipboardList,
  },
  {
    title: "Manage recurring cycles and medication schedules with ease",
    desc: "Set up repeat IVF cycles and ongoing gynaecology care with automated billing — no manual invoicing or payment chasing.",
    icon: Repeat,
  },
  {
    title: "Run group education sessions and fertility workshops",
    desc: "Organise group patient education sessions, manage attendance, and handle registrations alongside individual appointments — all from one system.",
    icon: Users,
  },
  {
    title: "Give patients access to their full care journey",
    desc: "Patients can view cycle notes, scan results, upcoming appointments, prescriptions, and shared resources — keeping them informed throughout treatment.",
...
const Prodfeatures = [
  {
    ...
    desc: "Create structured IVF and gynaecology consultation notes with hormone history, cycle data, and procedure documentation.",
  },
  {
    icon: FileText,
    category: "Clinical",
    title: "Centralised Patient Records",
    desc: "Access consultations, IVF cycle histories, scan reports, lab results, and treatment notes in one secure place.",
  },
  {
    icon: UserRound,
    category: "Patient",
    title: "Patient Portal",
    desc: "Patients can view appointments, invoices, cycle notes, scan results, and care resources anytime.",
  },
  {
    icon: Video,
    category: "Clinical",
    title: "Integrated Telehealth",
    desc: "Run secure virtual gynaecology and IVF consultations with built-in video and seamless patient access.",
  },
  {
    icon: CalendarDays,
    category: "Scheduling",
    title: "24/7 Online Booking",
    desc: "Let patients book consultations, scans, and cycle appointments anytime based on your live availability.",
  },
  {
    icon: BellRing,
    category: "Scheduling",
    title: "Reminders & Follow-ups",
    desc: "Reduce missed appointments with automated reminders for medications, scans, and procedure milestones.",
  },
  {
    icon: Receipt,
    category: "Billing",
    title: "Billing & Invoicing",
    desc: "Generate invoices instantly, track payments, and manage multi-cycle and OPD billing with ease.",
  },
  {
    icon: Repeat,
    category: "Practice",
    title: "Recurring Cycle Plans",
    desc: "Manage IVF programs, repeat cycles, antenatal visits, and scheduled gynaecology follow-up care.",
  },
  {
    icon: Smartphone,
    category: "Practice",
    title: "Manage On the Go",
    desc: "Access schedules, patient cycle notes, and scan reports from anywhere on any device.",
  },
  {
    icon: ShieldCheck,
    category: "Practice",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="max-w-2xl">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#009689]/10 border border-[#009689]/20 text-[#009689] text-sm font-semibold mb-6">
                ...
                Built for IVF & Gynaecology Clinics
              </div>
              <h1 className="text-4xl md:text-6xl font-sans tracking-tight leading-[1.1] mb-6">
                Advanced software for IVF & gynaecology clinics.
              </h1>
              <p className="text-lg md:text-xl text-slate-300 mb-10 leading-relaxed">
                Manage IVF cycles, gynaecology consultations, pregnancy
                journeys, and patient care workflows in one unified platform
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mb-16">
            <h2 className="text-4xl md:text-5xl font-sans text-slate-900 leading-tight">
              Running an IVF & gynaecology clinic
              <br />
          ...
          <div className="grid md:grid-cols-2 border border-slate-200 divide-y md:divide-y-0 md:divide-x divide-slate-200">
            ...
            <div className="p-12 bg-slate-50/50">
              ...
              <ul className="space-y-8">
                {[
                  "Patient records across IVF and OPD are scattered",
                  "Cycle tracking and gynaecology history are hard to manage",
                  "Follow-ups, scans, and key milestones get missed",
                  "No unified visibility across consultations, labs, and procedures",
                ].map((item, i) => (
            ...
            <div className="p-12 bg-white">
              ...
              <ul className="space-y-8">
                {[
                  "Everything unified across IVF and gynaecology workflows",
                  "Track cycles, consultations, scans, and treatment timelines",
                  "Automated reminders for visits, medications, and follow-ups",
                  "Real-time visibility into labs, procedures, and patient journeys",
                ].map((item, i) => (
                  <li key={i} className="flex items-start gap-4">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-5xl font-sans text-slate-900 mb-6">
              Everything you need to run and scale your IVF & gynaecology clinic
            </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <h2 className="text-3xl md:text-4xl font-sans text-slate-900 mb-6">
                Comprehensive records for IVF & gynaecology care
              </h2>
              <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                Capture every step of the patient journey — from initial
                consultation through IVF cycles, pregnancy, and postnatal care.
              </p>
              <ul className="space-y-5">
                {[
                  "Custom consultation forms for IVF and gynaecology",
                  "Track IVF cycles, scans, and hormone levels",
                  "Monitor pregnancy progress and ultrasound reports",
                  "Maintain detailed treatment, procedure, and follow-up notes",
                ].map((item, idx) => (
                ...
                <li className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-1 text-slate-600">
                      ...
                      consumables, and surgical supplies in real time
                    </p>
                  </div>
                </li>
                <li className="flex items-start">
      ...
      <section className="bg-white py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-600">
              Common questions from IVF & gynaecology clinic owners.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="max-w-4xl mx-auto bg-slate-800 border border-slate-700 rounded-3xl p-8 md:p-12 text-center shadow-2xl">
            ...
            <p className="text-2xl md:text-3xl leading-snug font-medium text-slate-200 mb-8 italic">
              "This platform has transformed how we manage IVF and gynaecology
              care. From consultations to cycle tracking and pregnancy
              management, everything is seamless and structured."
            </p>
            <div>
              <h4 className="font-sans text-xl text-white">Dr. Priya Sharma</h4>
              <p className="text-[#009689] font-medium">
                Clinical Director, Nova IVF & Gynaecology Centre
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-slate-900 py-24 border-t border-slate-800 relative overflow-hidden text-center">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <h2 className="text-4xl md:text-5xl font-sans text-white mb-6">
            Ready to modernize your IVF & gynaecology clinic?
          </h2>

          <p className="text-xl text-slate-300 mb-10">
            Join leading IVF and gynaecology clinics improving outcomes,
            enhancing patient experience, and scaling with confidence.
          </p>
