...
const faqs = [
  {
    question: "Is this software suitable for pelvic health clinics?",
    answer:
      "Yes, it is designed for pelvic health clinics, supporting physiotherapy assessments, rehabilitation programs, exercise tracking, and long-term patient management.",
  },
  {
    question: "Can I track patient exercise adherence and home programs?",
    answer:
      "Yes, you can assign home exercise programs, track adherence, and send automated reminders to keep patients consistent between sessions.",
  },
  {
    question: "Does it support recurring therapy sessions and follow-ups?",
    answer:
      "Yes, you can manage ongoing rehabilitation programs, automate follow-up reminders, and track session progress over time.",
  },
  {
    question: "Can I manage assessments and therapy notes in one place?",
    answer:
      "Yes, assessment forms, session notes, treatment plans, and patient history are all unified in a single secure system.",
  },
];
...
const portalFeatures: PortalFeature[] = [
  ...
  {
    title: "Build and track personalised pelvic therapy plans",
    desc: "Create structured rehabilitation programs for pelvic floor conditions. Each session is tracked automatically with clear visibility into progress and remaining appointments.",
    icon: ClipboardList,
  },
  {
    title: "Manage recurring therapy and exercise programs with ease",
    desc: "Set up ongoing pelvic health programs with automated billing and exercise reminders, so you never have to chase payments or missed sessions manually.",
    icon: Repeat,
  },
  {
    title: "Run group classes and pelvic health workshops",
    desc: "Organise group pelvic floor classes, manage attendance, and handle registrations alongside individual appointments — all from one system.",
    icon: Users,
  },
  {
    title: "Give patients visibility into their rehabilitation journey",
    desc: "Patients can view session notes, exercise plans, upcoming appointments, and shared resources — helping them stay consistent between sessions.",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="max-w-2xl">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#009689]/10 border border-[#009689]/20 text-[#009689] text-sm font-semibold mb-6">
                ...
                Built for Pelvic Health Clinics
              </div>
              <h1 className="text-4xl md:text-6xl font-sans tracking-tight leading-[1.1] mb-6">
                Advanced software for pelvic health clinics.
              </h1>
              <p className="text-lg md:text-xl text-slate-300 mb-10 leading-relaxed">
                Manage consultations, therapy plans, diagnostics, and long-term
                pelvic care — all in one unified platform built for modern
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mb-16">
            <h2 className="text-4xl md:text-5xl font-sans text-slate-900 leading-tight">
              Running a pelvic health clinic
              <br />
          ...
          <div className="grid md:grid-cols-2 border border-slate-200 divide-y md:divide-y-0 md:divide-x divide-slate-200">
            ...
            <div className="p-12 bg-slate-50/50">
              ...
              <ul className="space-y-8">
                {[
                  "Patient progress across therapy sessions is hard to track",
                  "Treatment plans and exercise adherence lack visibility",
                  "Follow-ups and long-term care coordination are inconsistent",
                  "No unified view of assessments, notes, and outcomes",
                ].map((item, i) => (
            ...
            <div className="p-12 bg-white">
              ...
              <ul className="space-y-8">
                {[
                  "Everything unified across pelvic health workflows",
                  "Track assessments, therapy sessions, and treatment plans",
                  "Automated reminders for exercises and follow-ups",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-5xl font-sans text-slate-900 mb-6">
              Everything you need to run and scale your pelvic health clinic
            </h2>
            <p className="text-lg text-slate-600">
              Automate workflows, track therapy outcomes, and improve patient
            ...
            {[
              {
                ...
                title: "Save time",
                description:
                  "Automate session documentation, therapy plans, and follow-ups so your team can focus on patient care.",
                stat: "4.2 hrs",
              ...
              },
              {
                ...
                description:
                  "Track therapy progress, assessments, and outcomes with structured timelines and insights.",
                stat: "89%",
              ...
              },
              {
                ...
                title: "Grow revenue",
                description:
                  "Increase patient retention and session adherence with automated reminders and structured care plans.",
                stat: "3.1x",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <h2 className="text-3xl md:text-4xl font-sans text-slate-900 mb-6">
                Comprehensive records for pelvic health care
              </h2>
              ...
              <ul className="space-y-5">
                {[
                  "Custom assessment forms for pelvic health conditions",
                  "Track therapy sessions, notes, and treatment plans",
                  "Monitor progress across rehabilitation programs",
          ...
          <div className="relative h-[420px] hidden lg:block">
            <div className="absolute left-0 top-8 w-56 bg-white rounded-2xl shadow-sm border border-slate-100 p-5">
              ...
              <div className="space-y-4 text-sm">
                ...
                <div className="text-slate-400">Session Notes</div>
              </div>
            </div>
            ...
            <div className="absolute left-36 top-16 w-80 bg-slate-50 rounded-3xl border border-slate-200 shadow-lg p-6">
              ...
              <div className="space-y-4 text-sm text-slate-600">
                <div>
                  ...
                  <p>Pelvic Health Physiotherapist</p>
                </div>
      ...
      <section className="bg-white py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-600">
              Common questions from pelvic health clinic owners.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="max-w-4xl mx-auto bg-slate-800 border border-slate-700 rounded-3xl p-8 md:p-12 text-center shadow-2xl">
            ...
            <p className="text-2xl md:text-3xl leading-snug font-medium text-slate-200 mb-8 italic">
              "This platform has transformed how we manage pelvic health care.
            ...
            <div>
              ...
              <p className="text-[#009689] font-medium">
                Clinical Director, Restore Pelvic Health Centre
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-slate-900 py-24 border-t border-slate-800 relative overflow-hidden text-center">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <h2 className="text-4xl md:text-5xl font-sans text-white mb-6">
            Ready to modernize your pelvic health clinic?
          </h2>

          <p className="text-xl text-slate-300 mb-10">
            Join leading pelvic health clinics improving outcomes, enhancing
