...
const features = [
  {
    ...
    desc: "Collect patient history, lifestyle information, and functional challenges before the first session.",
  },
  {
    icon: FolderOpen,
    category: "Clinical",
    title: "Centralised Patient Records",
    desc: "Store session notes, functional assessments, and progress reports securely in one place.",
  },
  {
    icon: UserCircle,
    category: "Patient",
    title: "Patient Portal",
    desc: "Patients and caregivers can access therapy plans, session notes, and resources anytime.",
  },
  {
    icon: Video,
    category: "Clinical",
    title: "Integrated Telehealth",
    desc: "Deliver remote occupational therapy sessions with secure, built-in video.",
  },
  {
    icon: CalendarCheck,
    category: "Scheduling",
    title: "24/7 Online Booking",
    desc: "Patients can book appointments anytime based on your real-time availability.",
  },
  {
    icon: BellRing,
    category: "Scheduling",
    title: "Reminders & Follow-ups",
    desc: "Reduce no-shows and keep therapy consistent with automated reminders.",
  },
  {
    icon: Pill,
    category: "Scheduling",
    title: "Therapy Plans & Session Tracking",
    desc: "Track session usage and monitor progress across functional therapy goals.",
  },
  {
    icon: Mic,
    category: "Practice",
    title: "Recurring Therapy Plans",
    desc: "Set up long-term therapy programs with automated billing.",
  },
  {
    icon: Smartphone,
    category: "Practice",
    title: "Manage Your Practice On the Go",
    desc: "Access schedules, patient notes, and updates from anywhere.",
  },
  {
    icon: ShieldCheck,
    category: "Practice",
    title: "Secure & Fully Compliant",
    desc: "Keep patient data safe with HIPAA and GDPR-compliant security.",
  },
];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="max-w-2xl">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#009689]/10 border border-[#009689]/20 text-[#009689] text-sm font-semibold mb-6">
                ...
                Built for Occupational Therapy Clinics
              </div>
              <h1 className="text-4xl md:text-6xl font-sans tracking-tight leading-[1.1] mb-6">
                Run your occupational therapy practice without admin overwhelm.
              </h1>
              <p className="text-lg md:text-xl text-slate-300 mb-10 leading-relaxed">
                Built for occupational therapists who want to focus on patient
                independence and functional outcomes — not paperwork.{" "}
              </p>{" "}
            ...
            <div className="p-12 bg-slate-50/50">
              <header className="flex items-center gap-3 mb-10">
                ...
                <p className="text-[10px] font-sans uppercase tracking-[0.3em] text-slate-400">
                  Challenges for Occupational Therapy Clinics
                </p>
              </header>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-5xl font-sans text-slate-900 mb-6">
              Everything you need to run and scale your occupational therapy
              practice without burnout.
            </h2>
            <p className="text-lg text-slate-600">
              From scheduling and patient management to documentation and
              billing — all the tools you need to grow your occupational therapy
              practice without administrative overload.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <h2 className="text-3xl md:text-4xl font-sans text-slate-900 mb-6">
                Capture functional goals and track patient progress easily
              </h2>
              ...
              <ul className="space-y-5">
                {[
                  ...
                  "Session notes and functional therapy goals stored in unified records",
                  "Track patient progress in daily living and motor skills over time",
                  "Secure video sessions for remote occupational therapy",
                ].map((item, idx) => (
      ...
      <section className="bg-white py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-600">
              Common questions from occupational therapists and clinic owners.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto bg-slate-800 border border-slate-700 rounded-3xl p-8 md:p-12 text-center shadow-2xl">
            ...
            <div>
              ...
              <p className="text-[#009689] font-medium">
                Occupational Therapist, Pediatric Therapy Clinic
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-slate-900 py-24 border-t border-slate-800 relative overflow-hidden text-center pt-12">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <p className="text-xl text-slate-300 mb-10">
            See how occupational therapy clinics automate scheduling,
            documentation, and patient management — without the admin chaos.
          </p>
