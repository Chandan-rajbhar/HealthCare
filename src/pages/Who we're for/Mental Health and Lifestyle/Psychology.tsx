...
const faqs = [
  {
    question: "Is this software suitable for therapists and psychologists?",
    answer:
      "Yes, it is designed for psychologists, therapists, counselors, and psychiatrists with workflows tailored to mental health practices.",
  },
  {
    question: "Can I manage recurring therapy sessions?",
    answer:
      "Yes, you can schedule ongoing sessions, automate reminders, and manage long-term therapy plans بسهولة.",
  },
  {
    question: "Does it support mental health assessments?",
    answer:
      "Yes, you can send standardized assessments and intake forms digitally before sessions.",
  },
  {
    question: "Are therapy notes and client data secure?",
    answer:
      "Yes, all records are encrypted and protected with strict access controls to ensure full confidentiality.",
  },
];
...
const portalFeatures = [
  ...
  {
    title: "Simplify onboarding for new therapy clients",
    desc: "Digital intake forms and assessments reduce friction and help therapists prepare before the first session.",
  },
  {
    title: "Match clients with the right therapist",
    desc: "Route clients based on therapy type, specialization, or clinician availability.",
  },
  {
    title: "Reduce missed therapy sessions",
    desc: "Automated reminders and easy rescheduling help maintain continuity of care.",
  },
  {
    title: "Ensure consistent revenue from sessions",
    desc: "Set deposits and cancellation policies to protect against last-minute cancellations.",
  },
];
// --- Main Page Component ---
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="max-w-2xl">
              ...
              <h1 className="text-4xl md:text-6xl font-sans tracking-tight leading-[1.1] mb-6">
                Advanced software for psychology practices.
              </h1>
              <p className="text-lg md:text-xl text-slate-300 mb-10 leading-relaxed">
                Manage therapy sessions, treatment plans, intake forms, notes,
          ...
          <div className="grid md:grid-cols-2 border border-slate-200 divide-y md:divide-y-0 md:divide-x divide-slate-200">
            ...
            <div className="p-12 bg-slate-50/50">
              ...
              <ul className="space-y-8">
                {[
                  "Patient notes and treatment plans are spread across systems",
                  "Manual intake forms slow down appointments",
                  "Follow-ups and recurring therapy sessions are hard to manage",
                  "No clear visibility into patient progress and outcomes",
                ].map((item, i) => (
      ...
      <section className="bg-white py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-600">
              Common questions from Psychology clinic owners.
            </p>
          </div>
      ...
      <section className="bg-slate-900 py-24 border-t border-slate-800 relative overflow-hidden text-center pt-12">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <h2 className="text-4xl md:text-5xl font-sans text-white mb-6">
            Ready to modernize your psychology practice?
          </h2>

          <p className="text-xl text-slate-300 mb-10">
            Join leading psychology practices improving outcomes, enhancing
