...
const features = [
  {
    ...
    desc: "Automatically converts spoken consultations into structured notes — history, diagnosis, treatment plans, and medical coding. Clinicians finish faster, admin load drops.",
  },
  {
    icon: ClipboardList,
    category: "Clinical",
    title: "Digital Intake Forms",
    desc: "Sends intake, medical history, and mental health questionnaires before appointments so patients arrive with paperwork already done.",
  },
  {
    icon: FolderOpen,
    category: "Clinical",
    title: "Centralized EHR",
    desc: "Progress notes, treatment plans, psychotherapy records, and visit history — all in one secure system, accessible across every visit.",
  },
  {
    icon: Pill,
    category: "Clinical",
    title: "Prescription & Medication Tracking",
    desc: "Track medication history, flag interactions, and manage refills directly inside the patient record. Built for psychiatric medication workflows.",
  },
  {
    icon: Video,
    category: "Clinical",
    title: "Telehealth Consultations",
    desc: "Secure built-in video for remote evaluations, therapy sessions, and medication follow-ups. Every session is automatically logged in the chart.",
  },
  {
    icon: UserCircle,
    category: "Patient",
    title: "Patient Portal",
    desc: "Patients securely view appointments, complete forms, access treatment history, and message the clinic — all without a phone call.",
  },
  {
    icon: CalendarCheck,
    category: "Scheduling",
    title: "24/7 Online Booking & Deposits",
    desc: "Patients book anytime without calling. Collect deposits at booking to reduce no-shows and protect clinic revenue from last-minute cancellations.",
  },
  {
    icon: BellRing,
    category: "Scheduling",
    title: "Automated Reminders & Waitlist",
    desc: "SMS and email reminders go out automatically. When a slot opens, waitlisted patients are notified instantly and can claim it themselves.",
  },
  {
    icon: Smartphone,
    category: "Practice",
    title: "Mobile App",
    desc: "Manage schedules, view patient records, and update notes from anywhere with Pabau Go — built for clinicians away from their desks.",
  },
  {
    icon: ShieldCheck,
    category: "Practice",
    title: "HIPAA / GDPR Compliance",
    desc: "End-to-end encryption, granular access controls, and full audit logs keep your clinic compliant with healthcare privacy regulations.",
  },
];

const faqs = [
  {
    question: "Is this software suitable for mental health clinics?",
    answer:
      "Yes, it is built for therapists, psychologists, psychiatrists, and counseling centers.",
  },
  {
    question: "Can I manage recurring therapy sessions?",
    answer:
      "Yes, automate recurring bookings, reminders, and follow-up scheduling.",
  },
  {
    question: "Does it support intake forms and treatment plans?",
    answer:
      "Yes, patients can complete forms digitally and clinicians can manage plans in one place.",
  },
  {
    question: "Can I keep secure therapy notes and patient records?",
    answer:
      "Yes, all records are securely stored with role-based access controls.",
  },
];

const portalFeatures = [
  {
    title: "Give patients self-service access through a secure portal",
    desc: "Patients can view appointments, complete intake forms, pay balances, and message your clinic securely.",
    cta: "Discover Patient Portal",
  },
  {
    title: "Simplify onboarding for new and returning patients",
    desc: "Digital forms, repeat bookings, and faster check-ins improve conversion.",
  },
  {
    title: "Connect patients to the right clinician instantly",
    desc: "Route patients to the right provider based on treatment type.",
  },
  {
    title: "Protect the schedule from revenue-draining gaps",
    desc: "Reduce no-shows using reminders, deposits, and waitlists.",
  },
  {
    title: "Set clear deposits and ensure steady cash flow",
    desc: "Collect upfront fees and automate payment recovery.",
  },
];
// --- Main Page Component ---
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="max-w-2xl">
              ...
              <h1 className="text-4xl md:text-6xl font-sans tracking-tight leading-[1.1] mb-6">
                Advanced software for mental health clinics.
              </h1>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mb-16">
            <h2 className="text-4xl md:text-5xl font-sans text-slate-900 leading-tight">
              Running a mental health clinic
              <br />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <h2 className="text-3xl md:text-4xl font-sans text-slate-900 mb-6">
                Comprehensive records for mental health care
              </h2>
              ...
              <ul className="space-y-5">
                {[
                  "Custom intake and mental health assessment forms",
                  "Track treatment plans, medications, and session notes",
                  "Monitor patient progress over time",
                  "Maintain detailed follow-ups and care plans",
                ].map((item, idx) => (
          ...
          <div className="relative h-[420px] hidden lg:block">
            <div className="absolute left-0 top-8 w-56 bg-white rounded-2xl shadow-sm border border-slate-100 p-5">
              ...
              <div className="space-y-4 text-sm">
                ...
                <div className="text-slate-400">Lab Reports</div>
              </div>
            </div>
      ...
      <section className="bg-slate-900 py-24 border-t border-slate-800 relative overflow-hidden text-center pt-12">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <h2 className="text-4xl md:text-5xl font-sans text-white mb-6">
            Ready to modernize your mental health practice?
          </h2>

          <p className="text-xl text-slate-300 mb-10">
            Join leading mental health practices improving outcomes, enhancing
