...
const features = [
  {
    icon: Mic,
    category: "Clinical",
    title: "AI Therapy Notes & Documentation",
    desc: "Automatically converts therapy sessions into structured notes — SOAP notes, progress summaries, diagnoses, and treatment plans. Reduce documentation time after every session.",
  },
  {
    icon: ClipboardList,
    category: "Clinical",
    title: "Mental Health Intake & Assessments",
    desc: "Send intake forms, consent forms, and standardized mental health questionnaires (PHQ-9, GAD-7, etc.) before sessions.",
  },
  {
    icon: FolderOpen,
    category: "Clinical",
    title: "Centralized Therapy Records",
    desc: "Store psychotherapy notes, treatment plans, session history, and client progress securely in one unified system.",
  },
  {
    icon: Pill,
    category: "Clinical",
    title: "Medication Tracking for Psychiatry",
    desc: "Track psychiatric medications, monitor adherence, and manage prescriptions for patients requiring pharmacological treatment.",
  },
  {
    icon: Video,
    category: "Clinical",
    title: "Secure Teletherapy Sessions",
    desc: "Conduct remote therapy sessions with built-in video. Session notes and history are automatically linked to each patient.",
  },
  {
    icon: UserCircle,
    category: "Patient",
    title: "Client Portal",
    desc: "Clients can book sessions, complete assessments, access therapy history, and securely communicate with their therapist.",
  },
  {
    icon: CalendarCheck,
    category: "Scheduling",
    title: "Recurring Therapy Scheduling",
    desc: "Easily schedule weekly or ongoing therapy sessions with automated booking and deposits to reduce drop-offs.",
  },
  {
    icon: BellRing,
    category: "Scheduling",
    title: "Session Reminders & Waitlist",
    desc: "Automated reminders reduce missed sessions. Fill cancellations instantly with waitlisted clients.",
  },
  {
    icon: Smartphone,
    category: "Practice",
    title: "Manage Practice On-the-Go",
    desc: "Access schedules, therapy notes, and patient details anytime with a mobile-friendly experience.",
  },
  {
    icon: ShieldCheck,
    category: "Practice",
    title: "Confidential & Compliant",
    desc: "Built for sensitive mental health data with encryption, role-based access, and HIPAA/GDPR compliance.",
  },
];
...
const faqs = [
  {
    question:
      "Is this suitable practice management software for therapy practices?",
    answer:
      "Yes. It is used by therapists, counselors, and mental health professionals — supporting clinical documentation, scheduling, and client management in one system.",
  },
  {
    question: "Can it handle recurring therapy sessions and treatment plans?",
    answer:
      "Yes. The calendar supports recurring appointments for weekly or biweekly sessions, and records centralize treatment plans and client progress across every visit.",
  },
  {
    question: "How does it help reduce documentation time for therapists?",
    answer:
      "AI-powered documentation captures therapy notes in real time using voice-to-text, so therapists complete progress notes during or immediately after sessions — not hours later.",
  },
  {
    question:
      "Does it support telehealth video conferencing for virtual therapy?",
    answer:
      "Yes. Integrated video sessions let you offer remote therapy without switching platforms, keeping all client information and documentation in one place.",
  },
  {
    question: "Is it compliant with data protection requirements?",
    answer:
      "Yes. The platform supports HIPAA and GDPR compliance with role-based access controls, encryption, secure e-documents, and full audit trails built into every workflow.",
  },
];

const portalFeatures = [
  {
    title: "Let clients book and pay without calling the office",
    desc: "24/7 online scheduling with deposit collection means sessions get booked outside office hours and clients confirm their commitment upfront.",
    cta: "Discover Online Bookings",
  },
  {
    title: "Reduce no-shows before they cost you billable hours",
    desc: "Automated appointment reminders via SMS and email go out before every session so clients remember and cancel with enough notice to rebook.",
  },
  {
    title: "Fill last-minute cancellations from your waitlist automatically",
    desc: "When cancellations happen, waitlisted clients get notified instantly and can claim the open slot — no manual phone calls required.",
  },
  {
  ...
  {
    title: "Give clients a private, secure therapy portal",
    desc: "Clients can book sessions, complete intake forms, access therapy documents, and message their therapist securely.",
    cta: "Discover Client Portal",
  },
];
// --- Main Page Component ---

export default function TherapyCounselling() {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="max-w-2xl">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#009689]/10 border border-[#009689]/20 text-[#009689] text-sm font-semibold mb-6">
                ...
                Built for Therapy & Counselling Practices
              </div>
              <h1 className="text-4xl md:text-6xl font-sans tracking-tight leading-[1.1] mb-6">
                Create space for therapeutic breakthroughs, not admin backlogs.
              </h1>
              <p className="text-lg md:text-xl text-slate-300 mb-10 leading-relaxed">
                Run your therapy practice with all-in-one software that reduces
                admin burden, streamlines scheduling, and strengthens client
                care — all from one connected system.{" "}
              </p>{" "}
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mb-16">
            <h2 className="text-4xl md:text-5xl font-sans text-slate-900 leading-tight">
              Even the best therapy practices hit a wall
              <br />
          ...
          <div className="grid md:grid-cols-2 border border-slate-200 divide-y md:divide-y-0 md:divide-x divide-slate-200">
            ...
            <div className="p-12 bg-slate-50/50">
              ...
              <ul className="space-y-8">
                {[
                  "Save 10+ hours per week with automated admin",
                  "One central patient record from booking to follow-up",
                  "AI-powered clinical documentation captured during sessions",
            ...
            <div className="p-12 bg-white">
              ...
              <ul className="space-y-8">
                {[
                  "Everything unified across your mental health workflows",
                  "Digital intake, notes, treatment plans, and scheduling in one place",
                  "Automated reminders for appointments and follow-ups",
                  "Real-time visibility into patient progress and retention",
                ].map((item, i) => (
                  <li key={i} className="flex items-start gap-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <h2 className="text-3xl md:text-4xl font-sans text-slate-900 mb-6">
                Complete therapy records, all in one place
              </h2>
              <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                Capture every step of the patient journey — from intake to
                therapy sessions, reviews, and long-term progress.
              </p>
              <ul className="space-y-5">
                {[
                  "Digital intake forms and standardized mental health assessments",
                  "Structured therapy notes, treatment plans, and session history",
                  "Track client progress across ongoing therapy sessions",
                  "Automated follow-ups and long-term care tracking",
                ].map((item, idx) => (
      ...
      <section className="bg-white py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-600">
              Common questions from therapists & counselors.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="max-w-4xl mx-auto bg-slate-800 border border-slate-700 rounded-3xl p-8 md:p-12 text-center shadow-2xl">
            ...
            <p className="text-2xl md:text-3xl leading-snug font-medium text-slate-200 mb-8 italic">
              "This platform has transformed how we manage mental health care.
              From intake assessments to therapy plans and long-term follow-ups,
      ...
      <section className="bg-slate-900 py-24 border-t border-slate-800 relative overflow-hidden text-center pt-12">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <h2 className="text-4xl md:text-5xl font-sans text-white mb-6">
            Grow without compromising client care.
          </h2>

          <p className="text-xl text-slate-300 mb-10">
            See how therapists & counselors reduce admin, improve client care,
            and increase revenue — all from one connected system.
          </p>
