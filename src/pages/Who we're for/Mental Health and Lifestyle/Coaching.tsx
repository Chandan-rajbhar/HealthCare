...
const faqs = [
  {
    question:
      "Can I sell coaching packages and track session usage automatically?",
    answer:
      "Yes. You can sell bundles like a 10-session pack and the platform automatically deducts a credit per booking and alerts you when the package is running low.",
  },
  {
    question: "Does it support group coaching sessions and workshops?",
    answer:
      "Yes. The Classes feature lets you schedule group coaching, manage attendee limits, and collect payments for workshops just as easily as 1:1 appointments.",
  },
  {
    question: "Is the system secure for sensitive client notes?",
    answer:
      "Yes. The platform is HIPAA and GDPR compliant with bank-grade encryption and strict access controls to ensure all client details and session notes remain private.",
  },
  {
    question: "Can clients book their own appointments online?",
    answer:
      "Yes. Clients can view your real-time availability and book discovery sessions or recurring appointments 24/7 via your booking page.",
  },
  {
    question: "Does it integrate with video conferencing for remote coaching?",
    answer:
      "Yes. Integrated telehealth hosts secure video sessions directly within the appointment workflow. Clients receive a unique link automatically when they book a virtual session.",
  },
  {
    question: "Can I set up recurring membership payments?",
    answer:
      "Yes. You can create coaching memberships that bill clients automatically on a weekly, monthly, or annual basis — ideal for retainer-based coaching models.",
  },
];
const portalFeatures = [
  {
    title: "Let clients book themselves 24/7 without back-and-forth",
    desc: "Automated SMS and email reminders reduce no-shows. Smart recall tracks when clients need follow-ups and sends reminders automatically.",
    cta: "Discover Online Bookings",
  },
  {
    title: "Secure long-term commitment with coaching packages",
    desc: "Sell session bundles that track and deduct credits automatically as they are used, notifying clients when it's time to renew.",
  },
  {
    title: "Stabilize revenue with recurring subscriptions",
    desc: "Monthly coaching retainers are collected via automated billing, removing the awkwardness of chasing invoices or payment plans.",
  },
  {
    title: "Deliver workshops and group coaching seamlessly",
    desc: "Manage registrations, payments, and attendee lists for group programs alongside private appointments — maximizing revenue per hour.",
  },
  {
    title: "Give clients secure access to their portal and resources",
    desc: "Clients can access session notes, upcoming appointments, and tailored resources — keeping them accountable between sessions.",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="max-w-2xl">
              ...
              <h1 className="text-4xl md:text-6xl font-sans tracking-tight leading-[1.1] mb-6">
                Turn your coaching business into a self-driving engine.
              </h1>
              <p className="text-lg md:text-xl text-slate-300 mb-10 leading-relaxed">
                Manage deep client relationships, recurring coaching
                memberships, and group programs — all from one connected
                platform built for coaches who want to grow without the admin
                burnout.{" "}
              </p>{" "}
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mb-16">
            <h2 className="text-4xl md:text-5xl font-sans text-slate-900 leading-tight">
              Even the best coaches hit a wall
              <br />
          ...
          <div className="grid md:grid-cols-2 border border-slate-200 divide-y md:divide-y-0 md:divide-x divide-slate-200">
            ...
            <div className="p-12 bg-slate-50/50">
              ...
              <ul className="space-y-8">
                {[
                  "Valuable hours consumed by back-and-forth email conversations with clients",
                  "Client progress stalls when homework and goals are buried in email threads",
                  "Revenue is unpredictable due to manual tracking of coaching packages",
                  "Discovery sessions slip through the cracks without a structured lead pipeline",
                ].map((item, i) => (
            ...
            <div className="p-12 bg-white">
              ...
              <ul className="space-y-8">
                {[
                  "Your calendar fills automatically via 24/7 self-scheduling",
                  "Accountability maintained with a dedicated client portal for content delivery",
                  "Cash flow secured through automated billing and payment plans",
                  "Group coaching and workshops managed seamlessly alongside private sessions",
                ].map((item, i) => (
                  <li key={i} className="flex items-start gap-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <h2 className="text-3xl md:text-4xl font-sans text-slate-900 mb-6">
                Capture the full client story and keep them engaged
              </h2>
              <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                Coaching agreements, intake questionnaires, session notes, and
                client resources — all stored securely and accessible at every
                touchpoint.
              </p>
              <ul className="space-y-5">
                {[
                  "Coaching agreements and intake questionnaires completed digitally before the first session",
                  "Client notes, homework assignments, and progress reviews stored in unified records",
                  "Resource sharing and video libraries accessible to clients 24/7 via the client portal",
                  "Secure integrated video for remote coaching sessions linked directly to the appointment",
                ].map((item, idx) => (
      ...
      <section className="bg-white py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-600">
              Common questions from coaches and coaching business owners.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="max-w-4xl mx-auto bg-slate-800 border border-slate-700 rounded-3xl p-8 md:p-12 text-center shadow-2xl">
            ...
            <p className="text-2xl md:text-3xl leading-snug font-medium text-slate-200 mb-8 italic">
              "I used to spend hours every week chasing bookings and invoices.
              Now it all runs automatically and I can focus entirely on my
              clients."
            </p>
            <div>
      ...
      <section className="bg-slate-900 py-24 border-t border-slate-800 relative overflow-hidden text-center pt-12">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <h2 className="text-4xl md:text-5xl font-sans text-white mb-6">
            Focus on transformation, not administration.
          </h2>

          <p className="text-xl text-slate-300 mb-10">
            See how coaching businesses automate bookings, packages, and client
            engagement — and deliver life-changing results without the backend
            chaos.
          </p>
