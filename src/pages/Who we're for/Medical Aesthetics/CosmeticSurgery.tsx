...
const faqs = [
  ...
  {
    question: "Can I manage injectables and surgical inventory?",
    answer:
      "Yes, track fillers, Botox, implants, and other supplies with batch, expiry, and stock monitoring.",
  },
];
...
const portalFeatures: PortalFeature[] = [
  {
    ...
    desc: "Patients view your real-time availability and book anytime. Automated SMS and email reminders reduce no-shows and keep surgical schedules running smoothly.",
    cta: "Discover Online Bookings",
    icon: CalendarCheck,
  },
  {
    title: "Manage multi-stage surgical journeys automatically",
    desc: "Build structured treatment plans covering consultation, procedure, and recovery phases. Each stage is tracked automatically with full visibility into progress.",
    icon: ClipboardList,
  },
  {
    title: "Handle recurring follow-ups and post-op billing",
    desc: "Set up automated post-operative follow-up schedules and billing so nothing falls through the cracks after surgery.",
    icon: Repeat,
  },
  {
    title: "Run group consultations and patient education sessions",
    desc: "Organize group cosmetic consultations, manage registrations, and handle attendance alongside individual appointments — all from one system.",
    icon: Users,
  },
  {
    title: "Give patients access to their surgical journey",
    desc: "Patients can view procedure notes, before-and-after images, upcoming appointments, and post-op instructions — keeping them informed and engaged.",
...
const Prodfeatures = [
  {
    ...
    desc: "Create structured surgical consultation notes quickly with procedure-specific templates, history tracking, and faster documentation.",
  },
  {
    icon: FileText,
    category: "Clinical",
  ...
  },
  {
    ...
    desc: "Run secure virtual pre-op and post-op consultations with built-in video and seamless patient access.",
  },
  {
    icon: CalendarDays,
    category: "Scheduling",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="max-w-2xl">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#009689]/10 border border-[#009689]/20 text-[#009689] text-sm font-semibold mb-6">
                ...
                Built for Cosmetic Surgery Clinics
              </div>
              <h1 className="text-4xl md:text-6xl font-sans tracking-tight leading-[1.1] mb-6">
                Modern software for cosmetic surgery practices.
              </h1>
              <p className="text-lg md:text-xl text-slate-300 mb-10 leading-relaxed">
                ...
                with software built for cosmetic surgery clinics.{" "}
              </p>{" "}
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mb-16">
            <h2 className="text-4xl md:text-5xl font-sans text-slate-900 leading-tight">
              Even the best cosmetic surgery clinics hit a wall
              <br />
            ...
            <div className="p-12 bg-slate-50/50">
              <header className="flex items-center gap-3 mb-10">
                ...
                <p className="text-[10px] font-sans uppercase tracking-[0.3em] text-slate-400">
                  Challenges for Cosmetic Surgery Clinics
                </p>
              </header>
              ...
              <ul className="space-y-8">
                {[
                  ...
                  "Patient records and surgical histories scattered across disconnected systems",
                  "Billing delays and admin errors slowing down cash flow",
                  "Too much admin reducing time for procedures and patient care",
                ].map((item, i) => (
            ...
            <div className="p-12 bg-white">
              <header className="flex items-center gap-3 mb-10">
                ...
                <p className="text-[10px] font-sans uppercase tracking-[0.3em] text-[#009689] font-semibold">
                  With your all-in-one cosmetic surgery platform
                </p>
              </header>
              ...
              <ul className="space-y-8">
                {[
                  ...
                  "Secure patient records, procedure notes, and surgical history in one place",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-5xl font-sans text-slate-900 mb-6">
              Everything you need to run and scale your cosmetic surgery clinic
              without burnout.
            </h2>
            <p className="text-lg text-slate-600">
              From scheduling and patient management to procedure notes and
              billing — all the tools you need to grow your cosmetic surgery
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <h2 className="text-3xl md:text-4xl font-sans text-slate-900 mb-6">
                Comprehensive records for cosmetic procedures
              </h2>
              ...
              <ul className="space-y-5">
                {[
                  "Custom consultation forms for aesthetic procedures",
                  "Track multi-stage cosmetic treatment plans",
                  "Store before & after images with timeline comparison",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="order-2 lg:order-1">
              ...
              <h2 className="text-3xl md:text-4xl font-sans text-slate-900 mb-6">
                Manage injectables, implants, and surgical inventory
              </h2>
              <p className="text-lg text-slate-600 mb-8">
                Track high-value cosmetic inventory including fillers, Botox,
                implants, and surgical consumables with full visibility.
              </p>
          ...
          <div className="relative h-[420px] hidden lg:block">
            <div className="absolute left-0 top-8 w-56 bg-white rounded-2xl shadow-sm border border-slate-100 p-5">
              ...
              <div className="space-y-4 text-sm">
                ...
                <div className="text-slate-400">Procedure Notes</div>
              </div>
            </div>
            ...
            <div className="absolute left-36 top-16 w-80 bg-slate-50 rounded-3xl border border-slate-200 shadow-lg p-6">
              ...
              <p className="text-slate-500 mb-6">Cosmetic Surgeon</p>
      ...
      <section className="bg-white py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-600">
              Common questions from cosmetic surgery clinic owners.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="max-w-4xl mx-auto bg-slate-800 border border-slate-700 rounded-3xl p-8 md:p-12 text-center shadow-2xl">
            ...
            <p className="text-2xl md:text-3xl leading-snug font-medium text-slate-200 mb-8 italic">
              "This platform has transformed how we manage cosmetic procedures.
              From consultations to post-op care, everything is seamless,
      ...
      <section className="bg-slate-900 py-24 border-t border-slate-800 relative overflow-hidden text-center">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <h2 className="text-4xl md:text-5xl font-sans text-white mb-6">
            Ready to modernize your Cosmetic Surgery clinic?
          </h2>
