...
const faqs = [
  {
    question: "Is this software suitable for dermatology clinics?",
    answer:
      "Yes, it is designed specifically for dermatology practices, supporting consultations, diagnoses, treatment plans, and long-term patient care.",
  },
  {
    question: "Can I track chronic skin conditions?",
    answer:
      "Yes, you can manage conditions like acne, eczema, psoriasis, and track progress over time with detailed records.",
  },
  {
    question: "Does it support clinical image tracking?",
    answer:
      "Yes, attach and store patient images to monitor treatment progress and improve diagnosis accuracy.",
  },
  {
    question: "Can I manage prescriptions and medications?",
    answer:
      "Yes, maintain prescription history, track medications, and manage in-clinic pharmacy inventory.",
  },
];
...
const Prodfeatures = [
  {
    ...
    desc: "Create structured dermatology notes quickly with condition-specific templates, history tracking, and faster documentation.",
  },
  {
    icon: FileText,
    category: "Clinical",
  ...
  },
  {
    ...
    desc: "Run secure virtual dermatology consultations with built-in video and seamless patient access.",
  },
  {
    icon: CalendarDays,
    category: "Scheduling",
...
const portalFeatures: PortalFeature[] = [
  {
    ...
    desc: "Patients view your real-time availability and book anytime. Automated SMS and email reminders reduce no-shows and keep schedules running smoothly.",
    cta: "Discover Online Bookings",
    icon: CalendarCheck,
  },
  {
    title: "Create structured treatment plans and track progress",
    desc: "Build dermatology care plans for chronic conditions like acne, eczema, and psoriasis. Each visit is logged automatically with full visibility into completed and upcoming sessions.",
    icon: ClipboardList,
  },
  {
    title: "Manage recurring care plans and automated billing",
    desc: "Set up ongoing treatment programs with automated billing so you never chase payments or manage invoices manually.",
    icon: Repeat,
  },
  {
    title: "Run group patient education sessions",
    desc: "Organize group skincare workshops, manage registrations, and handle attendance alongside individual appointments — all from one system.",
    icon: Users,
  },
  {
    title: "Give patients access to their skin treatment journey",
    desc: "Patients can view consultation notes, progress images, upcoming appointments, and aftercare instructions — keeping them engaged between visits.",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="max-w-2xl">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#009689]/10 border border-[#009689]/20 text-[#009689] text-sm font-semibold mb-6">
                ...
                Built for Dermatology Clinics
              </div>
              <h1 className="text-4xl md:text-6xl font-sans tracking-tight leading-[1.1] mb-6">
                Modern software for dermatology clinics.
              </h1>
              <p className="text-lg md:text-xl text-slate-300 mb-10 leading-relaxed">
                Streamline patient consultations, manage chronic skin
                conditions, track treatments, and improve clinical efficiency
                with software designed for dermatologists and skin
                specialists.{" "}
              </p>{" "}
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mb-16">
            <h2 className="text-4xl md:text-5xl font-sans text-slate-900 leading-tight">
              Even the best dermatology clinics hit a wall
              <br />
            ...
            <div className="p-12 bg-slate-50/50">
              <header className="flex items-center gap-3 mb-10">
                ...
                <p className="text-[10px] font-sans uppercase tracking-[0.3em] text-slate-400">
                  Challenges for Dermatology Clinics
                </p>
              </header>
              ...
              <ul className="space-y-8">
                {[
                  ...
                  "Patient records and skin imaging scattered across disconnected systems",
                  "Billing delays and admin errors slowing down cash flow",
                  "Too much admin reducing time for diagnoses and patient care",
                ].map((item, i) => (
            ...
            <div className="p-12 bg-white">
              <header className="flex items-center gap-3 mb-10">
                ...
                <p className="text-[10px] font-sans uppercase tracking-[0.3em] text-[#009689] font-semibold">
                  With your all-in-one dermatology platform
                </p>
              </header>
              ...
              <ul className="space-y-8">
                {[
                  ...
                  "Secure patient records, skin images, and history in one place",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-5xl font-sans text-slate-900 mb-6">
              Everything you need to run and scale your dermatology clinic
              without burnout.
            </h2>
            <p className="text-lg text-slate-600">
              From scheduling and patient management to clinical notes and
              billing — all the tools you need to grow your dermatology clinic
            ...
            {[
              {
                ...
                stat: "4.2 hrs",
                statLabel: "saved per dermatologist per week",
              },
              {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <h2 className="text-3xl md:text-4xl font-sans text-slate-900 mb-6">
                Smart patient records for dermatology clinics
              </h2>
              <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                Capture detailed skin condition histories, treatment progress,
                and clinical images — all in one place.
              </p>
              <ul className="space-y-5">
                {[
                  "Custom intake forms for dermatology consultations",
                  "Track chronic skin conditions like acne, eczema, psoriasis",
                  "Attach clinical images for progress tracking",
                  "Maintain prescription and treatment history",
                ].map((item, idx) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="order-2 lg:order-1">
              ...
              <h2 className="text-3xl md:text-4xl font-sans text-slate-900 mb-6">
                Clinic inventory & treatment supply management
              </h2>
              <p className="text-lg text-slate-600 mb-8">
                Manage injectables, dermatology supplies, and clinical inventory
                with accuracy and full visibility.
              </p>
                ...
                <li className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-1 text-slate-600">
                      Instantly view stock levels for products and injectables
                    </p>
                  </div>
                </li>
                <li className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-1 text-slate-600">
                      Track batch numbers and expiry dates for injectables and
                      skincare products.
                    </p>
                  </div>
                </li>
      ...
      <section className="bg-white py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-600">
              Common questions from dermatology clinic owners.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="max-w-4xl mx-auto bg-slate-800 border border-slate-700 rounded-3xl p-8 md:p-12 text-center shadow-2xl">
            ...
            <p className="text-2xl md:text-3xl leading-snug font-medium text-slate-200 mb-8 italic">
              "This system has transformed how we manage dermatology cases. From
              diagnosis to follow-ups, everything is structured, efficient, and
              easy to track."
            </p>
            <div>
      ...
      <section className="bg-slate-900 py-24 border-t border-slate-800 relative overflow-hidden text-center">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <h2 className="text-4xl md:text-5xl font-sans text-white mb-6">
            Ready to modernize your dermatology clinic?
          </h2>

          <p className="text-xl text-slate-300 mb-10">
            Join dermatology clinics improving patient care, streamlining
            workflows, and delivering better outcomes.
          </p>
