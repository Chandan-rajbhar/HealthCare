...
const faqs = [
  {
    question: "Is this software suitable for cosmetic surgery clinics?",
    answer:
      "Yes, it is designed specifically for cosmetic and aesthetic practices, supporting consultations, procedures, and post-operative care workflows.",
  },
  {
    question: "Can I track before and after results?",
    answer:
      "Yes, you can securely store and compare before-and-after images with timeline tracking to monitor treatment outcomes.",
  },
  {
    question: "Does it support multi-stage procedures?",
    answer:
      "Yes, manage complete treatment journeys including consultation, procedure, and recovery phases.",
  },
  {
    question: "Can I manage injectables and skincare product inventory?",
    answer:
      "Yes, track fillers, Botox, skincare products, and consumables with batch, expiry, and stock monitoring.",
  },
];
...
const portalFeatures: PortalFeature[] = [
  {
    ...
    desc: "Clients view real-time availability and book anytime. Automated SMS and email reminders reduce no-shows and keep schedules running smoothly.",
    cta: "Discover Online Bookings",
    icon: CalendarCheck,
  },
  {
    title: "Create and track multi-stage treatment plans",
    desc: "Build structured treatment journeys for procedures like chemical peels, laser therapy, or injectables. Each stage is tracked automatically with full visibility.",
    icon: ClipboardList,
  },
  {
    title: "Manage recurring skincare programs with ease",
    desc: "Set up ongoing skincare maintenance plans with automated billing — no manual invoicing or chasing payments.",
    icon: Repeat,
  },
  {
    title: "Run group skin consultations and workshops",
    desc: "Organise group education sessions, manage attendance, and handle registrations alongside individual appointments — all from one system.",
    icon: Users,
  },
  {
    title: "Give clients access to their treatment journey",
    desc: "Clients can view treatment notes, upcoming appointments, before/after photos, and shared aftercare resources — keeping them engaged between visits.",
...
const Prodfeatures = [
  {
    ...
    desc: "Create structured skin consultation notes with templates, treatment history, and photo documentation.",
  },
  {
    icon: FileText,
    category: "Clinical",
    title: "Centralised Client Records",
    desc: "Access consultations, prescriptions, before/after photos, referrals, and history in one secure place.",
  },
  {
    icon: UserRound,
    category: "Client",
    title: "Client Portal",
    desc: "Clients can view appointments, invoices, treatment notes, and aftercare resources anytime.",
  },
  {
    icon: Video,
    category: "Clinical",
  ...
  },
  {
    ...
    desc: "Let clients book appointments anytime based on your live calendar availability.",
  },
  {
    icon: BellRing,
    category: "Scheduling",
  ...
  },
  {
    ...
    desc: "Manage ongoing skincare programs, repeat procedures, and scheduled follow-up care.",
  },
  {
    icon: Smartphone,
    category: "Practice",
    title: "Manage On the Go",
    desc: "Access schedules, client notes, and updates from anywhere on any device.",
  },
  {
    icon: ShieldCheck,
    category: "Practice",
...
export default function SkinClinic() {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="max-w-2xl">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#009689]/10 border border-[#009689]/20 text-[#009689] text-sm font-semibold mb-6">
                ...
                Built for Skin Clinics & Dermatology Practices
              </div>
              <h1 className="text-4xl md:text-6xl font-sans tracking-tight leading-[1.1] mb-6">
                Modern software for skin clinics.
              </h1>
              <p className="text-lg md:text-xl text-slate-300 mb-10 leading-relaxed">
                Streamline consultations, manage surgical journeys, track
                before-and-after results, and deliver premium client experiences
                with one connected platform built for dermatology and skin
                clinics.{" "}
              </p>{" "}
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mb-16">
            <h2 className="text-4xl md:text-5xl font-sans text-slate-900 leading-tight">
              Even the best skin clinics hit a wall
              <br />
            ...
            <div className="p-12 bg-white">
              <header className="flex items-center gap-3 mb-10">
                ...
                <p className="text-[10px] font-sans uppercase tracking-[0.3em] text-[#009689] font-semibold">
                  With your all-in-one skin clinic platform
                </p>
              </header>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-5xl font-sans text-slate-900 mb-6">
              Everything you need to run and grow your clinic
            </h2>
            <p className="text-lg text-slate-600">
              Automate workflows, track outcomes, and grow revenue — all from
              one platform built for skin clinics.
            </p>
          </div>
            ...
            {[
              {
                ...
                title: "Save time",
                description:
                  "Automate admin, documentation, and workflows so your team focuses on care — not paperwork.",
                stat: "4.2 hrs",
              ...
              },
              {
                ...
                description:
                  "Track real skin progress with visual timelines and before-and-after comparisons at every stage.",
                stat: "92%",
              ...
              },
              {
                ...
                title: "Grow revenue",
                description:
                  "Increase retention with packages, memberships, and automated follow-up plans.",
                stat: "3.5x",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <h2 className="text-3xl md:text-4xl font-sans text-slate-900 mb-6">
                Comprehensive records for skin treatments
              </h2>
              <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                Capture every step of the client journey — from consultation to
                post-op follow-ups — in one structured, visual record.
              </p>
              <ul className="space-y-5">
                {[
                  "Custom consultation forms for skin treatments",
                  "Track multi-stage cosmetic treatment plans",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="order-2 lg:order-1">
              ...
              <h2 className="text-3xl md:text-4xl font-sans text-slate-900 mb-6">
                Manage skincare products, injectables, and clinic inventory
              </h2>
              <p className="text-lg text-slate-600 mb-8">
                Track skincare products, injectables, and clinic consumables
                ...
                <li className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-1 text-slate-600">
                      Monitor stock levels of fillers, Botox, implants, and
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative h-[420px] hidden lg:block">
            ...
            <div className="absolute left-36 top-16 w-80 bg-slate-50 rounded-3xl border border-slate-200 shadow-lg p-6">
              ...
              <p className="text-slate-500 mb-6">Dermatologist</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="max-w-4xl mx-auto bg-slate-800 border border-slate-700 rounded-3xl p-8 md:p-12 text-center shadow-2xl">
            ...
            <p className="text-2xl md:text-3xl leading-snug font-medium text-slate-200 mb-8 italic">
              "This platform has transformed how we manage skin treatments. From
              consultations to follow-up care, everything is seamless,
      ...
      <section className="bg-slate-900 py-24 border-t border-slate-800 relative overflow-hidden text-center">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <h2 className="text-4xl md:text-5xl font-sans text-white mb-6">
            Ready to modernize your skin clinic?
          </h2>

          <p className="text-xl text-slate-300 mb-10">
            Join leading cosmetic clinics delivering premium client experiences,
            improving outcomes, and scaling their practice with confidence.
          </p>
