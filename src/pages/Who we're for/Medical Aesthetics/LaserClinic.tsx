...
const faqs = [
  {
    question: "Is this software suitable for laser hair removal clinics?",
    answer:
      "Yes, it is designed for laser and aesthetic clinics, supporting multi-session treatments, client tracking, and machine management.",
  },
  {
    question: "Can I track laser treatment progress across sessions?",
    answer:
      "Yes, you can visually compare before-and-after results across multiple laser sessions with structured timelines.",
  },
  {
    question: "Does it support different laser treatments?",
    answer:
      "Yes, it supports laser hair removal, pigmentation treatments, skin resurfacing, and other laser-based procedures.",
  },
  {
    question: "Can I manage laser machine usage and maintenance?",
    answer:
      "Yes, you can track machine usage, shot counts, servicing schedules, and consumable levels in real time.",
  },
];
...
const portalFeatures: PortalFeature[] = [
  {
    title: "Let clients book laser sessions 24/7 without phone calls",
    desc: "Clients view real-time availability and book anytime. Automated SMS and email reminders reduce no-shows and keep your laser schedule full.",
    cta: "Discover Online Bookings",
    icon: CalendarCheck,
  },
  {
    title: "Sell laser session packages and track progress automatically",
    desc: "Create structured multi-session packages for hair removal, pigmentation, or resurfacing. Each session is tracked automatically with clear visibility into completed and remaining treatments.",
    icon: ClipboardList,
  },
  {
    title: "Manage recurring laser programs with ease",
    desc: "Set up ongoing laser maintenance cycles with automated billing — no manual invoicing or payment chasing.",
    icon: Repeat,
  },
  {
    title: "Run group consultations and skin workshops",
    desc: "Organise group laser education sessions, manage attendance, and handle registrations alongside individual appointments — all from one system.",
    icon: Users,
  },
  {
    title: "Give clients access to their laser journey",
    desc: "Clients can view session notes, before/after photos, upcoming appointments, and aftercare resources — keeping them engaged between treatments.",
...
const Prodfeatures = [
  {
    ...
    desc: "Create structured laser consultation notes with skin type assessment, treatment history, and photo documentation.",
  },
  {
    icon: FileText,
    category: "Clinical",
    title: "Centralised Client Records",
    desc: "Access consultations, session logs, before/after photos, and treatment history in one secure place.",
  },
  {
    icon: UserRound,
    category: "Client",
    title: "Client Portal",
    desc: "Clients can view appointments, invoices, session notes, and aftercare resources anytime.",
  },
  {
    icon: Video,
    category: "Clinical",
    title: "Integrated Telehealth",
    desc: "Run secure virtual skin consultations with built-in video and seamless client access.",
  },
  {
    icon: CalendarDays,
    category: "Scheduling",
    title: "24/7 Online Booking",
    desc: "Let clients book laser sessions anytime based on your live calendar availability.",
  },
  {
    icon: BellRing,
    category: "Scheduling",
    title: "Reminders & Follow-ups",
    desc: "Reduce missed sessions with automated SMS and email reminders.",
  },
  {
    icon: Receipt,
    category: "Billing",
    title: "Billing & Invoicing",
    desc: "Generate invoices instantly, track payments, and manage laser package billing.",
  },
  {
    icon: Repeat,
    category: "Practice",
    title: "Recurring Treatment Cycles",
    desc: "Manage ongoing laser programs, repeat sessions, and scheduled maintenance cycles.",
  },
  {
    icon: Smartphone,
    category: "Practice",
    title: "Manage On the Go",
    desc: "Access schedules, client notes, and machine logs from anywhere on any device.",
  },
  {
    icon: ShieldCheck,
    category: "Practice",
    title: "Secure & Fully Compliant",
    desc: "Protect client data with enterprise-grade security and GDPR-ready compliance.",
  },
];
// --- Main Page Component ---

export default function LaserClinic() {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="max-w-2xl">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#009689]/10 border border-[#009689]/20 text-[#009689] text-sm font-semibold mb-6">
                ...
                Built for Laser & Aesthetic Clinics
              </div>
              <h1 className="text-4xl md:text-6xl font-sans tracking-tight leading-[1.1] mb-6">
                Advanced software for laser clinics.
              </h1>
              <p className="text-lg md:text-xl text-slate-300 mb-10 leading-relaxed">
                Streamline laser treatments, manage client skin journeys, track
                session progress, and deliver consistent results with one
                unified platform built for laser and aesthetic practices.{" "}
              </p>{" "}
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mb-16">
            <h2 className="text-4xl md:text-5xl font-sans text-slate-900 leading-tight">
              Even the best laser clinics hit a wall
              <br />
            ...
            <div className="p-12 bg-slate-50/50">
              <header className="flex items-center gap-3 mb-10">
                ...
                <p className="text-[10px] font-sans uppercase tracking-[0.3em] text-slate-400">
                  Challenges for Laser Clinics
                </p>
              </header>

              <ul className="space-y-8">
                {[
                  "Hours lost managing multi-session bookings and treatment rescheduling",
                  "Client records and session photos spread across disconnected systems",
                  "Billing delays and errors slowing down clinic cash flow",
                  "Too much admin reducing time for laser procedures and client care",
                ].map((item, i) => (
            ...
            <div className="p-12 bg-white">
              <header className="flex items-center gap-3 mb-10">
                ...
                <p className="text-[10px] font-sans uppercase tracking-[0.3em] text-[#009689] font-semibold">
                  With your all-in-one laser clinic platform
                </p>
              </header>

              <ul className="space-y-8">
                {[
                  "Bookings, cancellations, and session reminders handled automatically",
                  "Secure digital client records and treatment history in one place",
                  "Faster invoicing, smoother payments, and stronger revenue flow",
                  "More time for laser treatments instead of administrative work",
                ].map((item, i) => (
                  <li key={i} className="flex items-start gap-4">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-5xl font-sans text-slate-900 mb-6">
              Everything you need to run and scale your laser clinic
            </h2>
            <p className="text-lg text-slate-600">
              Automate workflows, track treatment outcomes, and increase repeat
              sessions — all from a platform built specifically for laser
              clinics.
            </p>
          </div>
            ...
            {[
              {
                ...
                title: "Save time",
                description:
                  "Automate laser session documentation, treatment logs, and client follow-ups so your team can focus on procedures instead of paperwork.",
                stat: "3.6 hrs",
                statLabel: "saved per laser technician per week",
              },
              {
                icon: <Activity className="w-8 h-8 text-[#009689]" />,
                title: "Improve outcomes",
                description:
                  "Track laser treatment progress across sessions with structured before-and-after comparisons and skin response timelines.",
                stat: "91%",
              ...
              },
              {
                ...
                title: "Grow revenue",
                description:
                  "Increase repeat laser sessions with structured treatment packages, cycle reminders, and membership plans.",
                stat: "3.4x",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <h2 className="text-3xl md:text-4xl font-sans text-slate-900 mb-6">
                Comprehensive records for laser treatments
              </h2>
              <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                Capture every step of the client journey — from consultation to
                post-laser follow-ups
              </p>
              <ul className="space-y-5">
                {[
                  "Custom consultation forms for laser treatments",
                  "Track multi-session laser treatment plans",
                  "Visual before & after tracking with timeline comparison",
                  "Maintain detailed laser procedure and recovery notes",
                ].map((item, idx) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="order-2 lg:order-1">
              ...
              <h2 className="text-3xl md:text-4xl font-sans text-slate-900 mb-6">
                Manage laser devices, consumables, and clinic inventory
              </h2>
              <p className="text-lg text-slate-600 mb-8">
                Track laser consumables, gels, cartridges, and clinic inventory
                ...
                <li className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-1 text-slate-600">
                      Monitor stock levels of laser consumables, gels,
                      cartridges, and cooling agents in real time
                    </p>
                  </div>
                </li>
                <li className="flex items-start">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative h-[420px] hidden lg:block">
            ...
            <div className="absolute left-36 top-16 w-80 bg-slate-50 rounded-3xl border border-slate-200 shadow-lg p-6">
              ...
              <p className="text-slate-500 mb-6">Laser Technician</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="max-w-4xl mx-auto bg-slate-800 border border-slate-700 rounded-3xl p-8 md:p-12 text-center shadow-2xl">
            ...
            <p className="text-2xl md:text-3xl leading-snug font-medium text-slate-200 mb-8 italic">
              "This platform has transformed how we manage laser treatments.
              From session tracking to automated follow-ups, everything is
              seamless and built for high-volume laser clinics."
            </p>
            <div>
              <h4 className="font-sans text-xl text-white">Dr. Priya Nair</h4>
              <p className="text-[#009689] font-medium">
                Clinical Director, Lumina Laser Clinic
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-slate-900 py-24 border-t border-slate-800 relative overflow-hidden text-center">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <h2 className="text-4xl md:text-5xl font-sans text-white mb-6">
            Ready to modernize your laser clinic?
          </h2>

          <p className="text-xl text-slate-300 mb-10">
            Join leading laser clinics delivering consistent treatment results,
            improving client retention, and scaling their practice with
            confidence.
          </p>
