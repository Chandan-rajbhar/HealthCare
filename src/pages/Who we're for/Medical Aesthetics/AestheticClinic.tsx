...
const faqs = [
  {
    question: "Is this software suitable for aesthetic clinics?",
    answer:
      "Yes, the platform is built for aesthetic clinics, dermatology practices, and cosmetic centers, supporting consultations, procedures, and patient journeys.",
  },
  {
    question: "Can I manage treatments and patient history?",
    answer:
      "Yes, track injectables, dermatology procedures, laser treatments, and complete patient history with detailed notes.",
  },
  {
    question: "Does it support packages and treatment plans?",
    answer:
      "Yes, create treatment plans, procedure packages, and recurring care programs to improve patient retention.",
  },
  {
    question: "Can I track inventory and medical supplies?",
    answer:
      "Yes, manage injectables, consumables, and clinic inventory with real-time tracking and alerts.",
  },
];
...
const portalFeatures: PortalFeature[] = [
  {
    ...
    desc: "Clients can view your real-time availability and book anytime. Automated SMS and email reminders reduce no-shows and keep schedules running smoothly.",
    cta: "Discover Online Bookings",
    icon: CalendarCheck,
  },
  {
    title: "Offer treatment packages and track sessions automatically",
    desc: "Create structured treatment plans and session bundles. Each appointment is tracked automatically, with clear visibility into completed and remaining sessions.",
    icon: ClipboardList,
  },
  {
    title: "Manage memberships and recurring billing with ease",
    desc: "Set up ongoing membership programs with automated billing so you never have to chase payments or manage invoices manually.",
    icon: Repeat,
  },
  {
    title: "Run group skincare sessions and wellness workshops",
    desc: "Organize group treatment sessions, manage attendance, and handle registrations alongside individual appointments — all from one system.",
    icon: Users,
  },
  {
    title: "Give clients access to their treatment history",
    desc: "Clients can view treatment notes, upcoming appointments, and aftercare resources — helping them stay engaged between visits.",
...
const Prodfeatures = [
  {
    ...
    desc: "Create structured aesthetic consultation notes quickly with templates, treatment history, and faster documentation.",
  },
  {
    icon: FileText,
    category: "Clinical",
  ...
  },
  {
    ...
    desc: "Offer secure online skin consultations with built-in video and seamless client access.",
  },
  {
    icon: CalendarDays,
    category: "Scheduling",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="max-w-2xl">
              ...
              <h1 className="text-4xl md:text-6xl font-sans tracking-tight leading-[1.1] mb-6">
                Elevate your aesthetic clinic experience.
              </h1>
              <p className="text-lg md:text-xl text-slate-300 mb-10 leading-relaxed">
                Save hours of admin time, manage high-value treatments
                effortlessly, and deliver premium client experiences with
                software designed for aesthetic clinics, cosmetic practices, and
                skin specialists.{" "}
              </p>{" "}
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mb-16">
            <h2 className="text-4xl md:text-5xl font-sans text-slate-900 leading-tight">
              Even the best aesthetic clinics hit a wall
              <br />
            ...
            <div className="p-12 bg-slate-50/50">
              <header className="flex items-center gap-3 mb-10">
                ...
                <p className="text-[10px] font-sans uppercase tracking-[0.3em] text-slate-400">
                  Challenges for Aesthetic Clinic Owners
                </p>
              </header>
              ...
              <ul className="space-y-8">
                {[
                  ...
                  "Client treatment records scattered across paper files and disconnected systems",
                  "Billing delays and admin errors slowing down cash flow",
                  "Too much admin reducing time for treatments and client care",
                ].map((item, i) => (
            ...
            <div className="p-12 bg-white">
              <header className="flex items-center gap-3 mb-10">
                ...
                <p className="text-[10px] font-sans uppercase tracking-[0.3em] text-[#009689] font-semibold">
                  With your all-in-one aesthetic clinic platform
                </p>
              </header>
              ...
              <ul className="space-y-8">
                {[
                  ...
                  "Secure digital client profiles and treatment history in one place",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-5xl font-sans text-slate-900 mb-6">
              Everything you need to run and scale your aesthetic clinic without
              burnout.
            </h2>
            <p className="text-lg text-slate-600">
              From scheduling and client management to treatment notes and
              billing — all the tools you need to grow your aesthetic clinic
            ...
            {[
              {
                ...
                stat: "4.2 hrs",
                statLabel: "saved per practitioner per week",
              },
              {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <h2 className="text-3xl md:text-4xl font-sans text-slate-900 mb-6">
                Advanced patient records for aesthetic procedures
              </h2>
              <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                Maintain detailed patient histories including injectables,
                dermatology treatments, laser procedures, and personalized care
                plans—all in one place.
              </p>
              <ul className="space-y-5">
                {[
                  "Custom intake forms for Initial Consultations",
                  "Comprehensive patient profiles with medical history",
                  "Automated pre-consultation forms",
                  "Track injectables, dermatology procedures, and treatment plans",
                ].map((item, idx) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="max-w-4xl mx-auto bg-slate-800 border border-slate-700 rounded-3xl p-8 md:p-12 text-center shadow-2xl">
            ...
            <p className="text-2xl md:text-3xl leading-snug font-medium text-slate-200 mb-8 italic">
              "Managing our aesthetic clinic became effortless. From
              consultations to procedures and patient records, everything is
      ...
      <section className="bg-slate-900 py-24 border-t border-slate-800 relative overflow-hidden text-center">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <h2 className="text-4xl md:text-5xl font-sans text-white mb-6">
            Ready to scale your aesthetic clinic?
          </h2>

          <p className="text-xl text-slate-300 mb-10">
            Join leading aesthetic clinics delivering exceptional patient
            experiences and growing their practice with ease.
          </p>
