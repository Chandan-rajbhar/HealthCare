...
const faqs = [
  {
    question: "Is this software suitable for med spas?",
    answer:
      "Yes, the platform is built specifically for med spas, aesthetic clinics, and wellness centers, with tools for managing treatments, client journeys, and bookings.",
  },
  {
    question: "Can I manage aesthetic treatments and client history?",
    answer:
      "Absolutely. Track injectables, laser treatments, skincare procedures, and full client history with detailed notes and photos.",
  },
  {
    question: "Does it support memberships and packages?",
    answer:
      "Yes, you can create treatment packages, memberships, and prepaid plans to boost retention and recurring revenue.",
  },
  {
    question: "Can I track retail products and inventory?",
    answer:
      "Yes, manage skincare products, injectables, and clinic supplies with real-time stock tracking and alerts.",
  },
];
...
const portalFeatures: PortalFeature[] = [
  ...
  },
  {
    ...
    desc: "Set up ongoing membership programs with automated billing so you never chase payments or manage invoices manually.",
    icon: Repeat,
  },
  {
    title: "Run group wellness events and workshops",
    desc: "Organize group skincare sessions, manage attendance, and handle registrations alongside individual appointments — all from one system.",
    icon: Users,
  },
  {
    title: "Give clients access to their aesthetic treatment history",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="max-w-2xl">
              ...
              <h1 className="text-4xl md:text-6xl font-sans tracking-tight leading-[1.1] mb-6">
                Run and grow your med spa with ease.
              </h1>
              <p className="text-lg md:text-xl text-slate-300 mb-10 leading-relaxed">
                Save hours of admin time, manage bookings and treatments
                effortlessly, and deliver exceptional client experiences with
                software designed for med spas, aesthetics, and wellness
                clinics.{" "}
              </p>{" "}
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mb-16">
            <h2 className="text-4xl md:text-5xl font-sans text-slate-900 leading-tight">
              Even the best med spas hit a wall
              <br />
            ...
            <div className="p-12 bg-white">
              <header className="flex items-center gap-3 mb-10">
                ...
                <p className="text-[10px] font-sans uppercase tracking-[0.3em] text-[#009689] font-semibold">
                  With your all-in-one med spa platform
                </p>
              </header>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-5xl font-sans text-slate-900 mb-6">
              Everything you need to run and scale your med spa without burnout.
            </h2>
            <p className="text-lg text-slate-600">
              From scheduling and patient management to clinical notes and
              billing , all the tools you need to grow your med spa without
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <h2 className="text-3xl md:text-4xl font-sans text-slate-900 mb-6">
                Smart client records for aesthetic treatments
              </h2>
              <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                Capture detailed treatment history including injectables, laser
                sessions, skincare plans, and client preferences—all in one
                place.
              </p>
              <ul className="space-y-5">
                {[
                  "Custom intake forms for aesthetic consultations",
                  "Detailed client profiles with treatment history",
                  "Pre-appointment forms sent automatically",
                  "Track injectables, laser sessions, and skincare treatments",
                ].map((item, idx) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="order-2 lg:order-1">
              ...
              <h2 className="text-3xl md:text-4xl font-sans text-slate-900 mb-6">
                Aesthetic inventory & product management
              </h2>
              <p className="text-lg text-slate-600 mb-8">
                Track injectables, skincare products, and clinic supplies with
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative h-[420px] hidden lg:block">
            ...
            <div className="absolute left-36 top-16 w-80 bg-slate-50 rounded-3xl border border-slate-200 shadow-lg p-6">
              ...
              <p className="text-slate-500 mb-6">Aesthetic Practitioner</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="max-w-4xl mx-auto bg-slate-800 border border-slate-700 rounded-3xl p-8 md:p-12 text-center shadow-2xl">
            ...
            <p className="text-2xl md:text-3xl leading-snug font-medium text-slate-200 mb-8 italic">
              "Managing our med spa became effortless. From bookings to
              treatments and client history, everything is streamlined and easy
              to use."
            </p>
            <div>
      ...
      <section className="bg-slate-900 py-24 border-t border-slate-800 relative overflow-hidden text-center">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <p className="text-xl text-slate-300 mb-10">
            Join leading med spas delivering exceptional client experiences and
            growing their business with ease.
          </p>
