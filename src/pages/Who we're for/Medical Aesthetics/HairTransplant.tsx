...
const portalFeatures: PortalFeature[] = [
  {
    ...
    desc: "Patients view real-time availability and book anytime. Automated SMS and email reminders reduce no-shows and keep your surgical schedule full.",
    cta: "Discover Online Bookings",
    icon: CalendarCheck,
  },
  {
    title: "Create and track full transplant journeys",
    desc: "Build structured patient journeys covering consultation, procedure, and multi-stage recovery. Each milestone is tracked automatically with full visibility.",
    icon: ClipboardList,
  },
  {
    title: "Manage post-op care programs with ease",
    desc: "Set up ongoing recovery and PRP maintenance programs with automated billing — no manual invoicing or payment chasing.",
    icon: Repeat,
  },
  {
    title: "Run group consultations and hair loss workshops",
    desc: "Organise group education sessions, manage attendance, and handle registrations alongside individual consultations — all from one system.",
    icon: Users,
  },
  {
    title: "Give patients access to their recovery journey",
    desc: "Patients can view procedure notes, graft progress photos, upcoming appointments, and aftercare instructions — keeping them engaged throughout recovery.",
...
const Prodfeatures = [
  {
    ...
    desc: "Create structured transplant consultation notes with hair loss assessment, graft planning, and donor area documentation.",
  },
  {
    icon: FileText,
    category: "Clinical",
    title: "Centralised Patient Records",
    desc: "Access consultations, procedure logs, graft counts, before/after photos, and recovery history in one secure place.",
  },
  {
    icon: UserRound,
    category: "Patient",
    title: "Patient Portal",
    desc: "Patients can view appointments, invoices, recovery notes, and post-op aftercare resources anytime.",
  },
  {
    icon: Video,
    category: "Clinical",
    title: "Integrated Telehealth",
    desc: "Run secure virtual follow-up consultations with built-in video and seamless patient access.",
  },
  {
    icon: CalendarDays,
    category: "Scheduling",
    title: "24/7 Online Booking",
    desc: "Let patients book consultations and follow-ups anytime based on your live calendar availability.",
  },
  {
    icon: BellRing,
    category: "Scheduling",
    title: "Reminders & Follow-ups",
    desc: "Reduce missed appointments with automated SMS and email reminders for procedures and recovery check-ins.",
  },
  {
    icon: Receipt,
    category: "Billing",
    title: "Billing & Invoicing",
    desc: "Generate invoices instantly, track payments, and manage transplant package billing with ease.",
  },
  {
    icon: Repeat,
    category: "Practice",
    title: "Post-Op Care Plans",
    desc: "Manage ongoing recovery programs, PRP sessions, and scheduled post-transplant follow-up care.",
  },
  {
    icon: Smartphone,
    category: "Practice",
    title: "Manage On the Go",
    desc: "Access schedules, patient records, and graft notes from anywhere on any device.",
  },
  {
    icon: ShieldCheck,
    category: "Practice",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="max-w-2xl">
              ...
              <h1 className="text-4xl md:text-6xl font-sans tracking-tight leading-[1.1] mb-6">
                Advanced software for hair transplant clinics.
              </h1>
              <p className="text-lg md:text-xl text-slate-300 mb-10 leading-relaxed">
                Streamline hair transplant procedures, manage patient journeys,
                track graft progress, and deliver consistent results with one
                unified platform built for hair restoration clinics.{" "}
              </p>{" "}
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mb-16">
            <h2 className="text-4xl md:text-5xl font-sans text-slate-900 leading-tight">
              Even the best hair transplant clinics hit a wall
              <br />
            ...
            <div className="p-12 bg-slate-50/50">
              <header className="flex items-center gap-3 mb-10">
                ...
                <p className="text-[10px] font-sans uppercase tracking-[0.3em] text-slate-400">
                  Challenges for Hair Transplant Clinics
                </p>
              </header>

              <ul className="space-y-8">
                {[
                  "Hours lost managing consultations, procedure bookings, and follow-up scheduling",
                  "Patient records and graft data spread across disconnected systems",
                  "Billing delays and errors slowing down clinic cash flow",
                  "Too much admin reducing time for surgical procedures and patient care",
                ].map((item, i) => (
            ...
            <div className="p-12 bg-white">
              <header className="flex items-center gap-3 mb-10">
                ...
                <p className="text-[10px] font-sans uppercase tracking-[0.3em] text-[#009689] font-semibold">
                  With your all-in-one transplant clinic platform
                </p>
              </header>

              <ul className="space-y-8">
                {[
                  "Bookings, follow-ups, and recovery reminders handled automatically",
                  "Secure digital patient records, graft data, and procedure history in one place",
                  "Faster invoicing, smoother payments, and stronger revenue flow",
                  "More time for transplant procedures instead of administrative work",
                ].map((item, i) => (
                  <li key={i} className="flex items-start gap-4">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-5xl font-sans text-slate-900 mb-6">
              Everything you need to run and scale your hair transplant clinic
            </h2>
            <p className="text-lg text-slate-600">
              Automate workflows, track transplant outcomes, and improve patient
              retention — all from a platform built specifically for hair
              transplant clinics.
            </p>
          </div>
            ...
            {[
              {
                ...
                title: "Save time",
                description:
                  "Automate transplant documentation, graft records, and post-op follow-ups so your team can focus on procedures instead of paperwork.",
                stat: "3.8 hrs",
                statLabel: "saved per surgeon per week",
              },
              {
                icon: <Activity className="w-8 h-8 text-[#009689]" />,
                title: "Improve outcomes",
                description:
                  "Track hair growth progress with structured before-and-after comparisons and graft recovery timelines.",
                stat: "94%",
              ...
              },
              {
                ...
                title: "Grow revenue",
                description:
                  "Increase referrals and retention with post-transplant care plans, PRP add-ons, and automated follow-up programs.",
                stat: "3.2x",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <h2 className="text-3xl md:text-4xl font-sans text-slate-900 mb-6">
                Comprehensive records for hair transplant procedures
              </h2>
              <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                Capture every step of the patient journey — from consultation to
                post-transplant recovery
              </p>
              <ul className="space-y-5">
                {[
                  "Custom consultation forms for transplant procedures",
                  "Track graft count, donor area, and transplant sessions",
                  "Visual before & after tracking with hair growth timelines",
                  "Maintain detailed procedure and recovery notes",
                ].map((item, idx) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="order-2 lg:order-1">
              ...
              <h2 className="text-3xl md:text-4xl font-sans text-slate-900 mb-6">
                Manage surgical tools, graft kits, and clinic inventory
              </h2>
              <p className="text-lg text-slate-600 mb-8">
                Track surgical consumables, graft kits, and clinic inventory
                ...
                <li className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-1 text-slate-600">
                      Monitor stock levels of graft kits, surgical tools, and
          ...
          <div className="relative h-[420px] hidden lg:block">
            <div className="absolute left-0 top-8 w-56 bg-white rounded-2xl shadow-sm border border-slate-100 p-5">
              ...
              <div className="space-y-4 text-sm">
                ...
                <div className="text-slate-400">Recovery Notes</div>
              </div>
            </div>
            ...
            <div className="absolute left-36 top-16 w-80 bg-slate-50 rounded-3xl border border-slate-200 shadow-lg p-6">
              ...
              <p className="text-slate-500 mb-6">Hair Transplant Surgeon</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="max-w-4xl mx-auto bg-slate-800 border border-slate-700 rounded-3xl p-8 md:p-12 text-center shadow-2xl">
            ...
            <p className="text-2xl md:text-3xl leading-snug font-medium text-slate-200 mb-8 italic">
              "This platform has transformed how we manage hair transplant
              procedures. From consultations to recovery tracking, everything is
              seamless, structured, and built for precision."
            </p>
            <div>
              <h4 className="font-sans text-xl text-white">Dr. James Okafor</h4>
              <p className="text-[#009689] font-medium">
                Clinical Director, Restore Hair Clinic
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-slate-900 py-24 border-t border-slate-800 relative overflow-hidden text-center">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <h2 className="text-4xl md:text-5xl font-sans text-white mb-6">
            Ready to modernize your hair transplant clinic?
          </h2>

          <p className="text-xl text-slate-300 mb-10">
            Join leading hair transplant clinics delivering consistent surgical
            outcomes, improving patient retention, and scaling their practice
            with confidence.
          </p>
