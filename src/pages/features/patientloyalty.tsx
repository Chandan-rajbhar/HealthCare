...
import { ChevronDown, Heart, Gift, Star, Users } from "lucide-react"
...
const FEATURES = [
  {
    ...
    description: "Reward loyal patients with points, offers, and exclusive benefits.",
  },
  {
    icon: Gift,
    title: "Loyalty programs",
    description: "Create custom loyalty programs to encourage repeat visits.",
  },
  {
    icon: Star,
    title: "VIP memberships",
    description: "Offer premium benefits for your most loyal patients.",
  },
  {
    icon: Users,
    title: "Retention insights",
    description: "Track repeat visits and understand patient loyalty trends.",
  },
]
const FAQ_ITEMS = [
  {
    q: "What is a patient loyalty program?",
    a: "A patient loyalty program rewards patients for repeat visits, treatments, and long-term engagement with your clinic.",
  },
  {
    q: "How does loyalty help clinics grow?",
    a: "Loyalty programs encourage repeat visits, strengthen patient relationships, and increase lifetime patient value.",
  },
  {
    q: "Can clinics customize loyalty rewards?",
    a: "Yes. Clinics can design custom rewards such as discounts, points, or exclusive benefits.",
  },
  {
    q: "Can loyalty programs increase retention?",
    a: "Yes. Loyalty programs motivate patients to return for treatments and build stronger relationships with clinics.",
  },
  {
    q: "Are loyalty programs easy to manage?",
    a: "Yes. HealVare allows clinics to easily track rewards, patient engagement, and loyalty performance.",
  },
]
...
>
            ...
            <motion.h1
              ...
              variants={fadeUp}
            >
            Build patient loyalty and retention
            </motion.h1>
            ...
            <motion.p
              ...
              variants={fadeUp}
            >
        Reward loyal patients and encourage repeat visits with smart loyalty programs.
            </motion.p>
            ...
            <motion.p
              ...
              variants={fadeUp}
            >
           HealVare Patient Loyalty helps clinics build long-term relationships with patients through rewards, programs, and personalized incentives.
            </motion.p>
        ...
        <div className="mx-auto max-w-6xl">
          <ScrollReveal>
            <h2 className="text-3xl font-semibold text-center text-gray-900">
             Everything you need to retain loyal patients
            </h2>
          </ScrollReveal>
          <ScrollReveal delay={0.08}>
            <p className="text-center text-gray-600 mt-4 max-w-2xl mx-auto">
             Create loyalty programs, reward repeat patients, and build lasting patient relationships.
            </p>
          </ScrollReveal>
...
heading="Reward loyal patients"
body="Create loyalty programs that reward patients for repeat visits and ongoing treatments."
bullets={[
  "Points-based loyalty programs",
  "Rewards for repeat visits",
  "Exclusive patient offers",
]}
/>

<DeepDiveRow
  imageLeft={false}
eyebrow="Stronger relationships"
heading="Increase repeat patient visits"
body="Encourage patients to return regularly with personalized rewards and loyalty incentives."
bullets={[
  "Personalized loyalty rewards",
  "VIP patient benefits",
...
/>
      ...
      <section className="py-20 px-6">
       ...
       See how HealVare Patient Loyalty helps clinics retain patients and grow repeat visits.
          </motion.p>
