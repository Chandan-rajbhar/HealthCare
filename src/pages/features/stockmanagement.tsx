...
import { ChevronDown, Package, ClipboardList, Warehouse, AlertTriangle } from "lucide-react"
...
const FEATURES = [
  {
    ...
    description: "Monitor stock levels for medicines, supplies, and clinic products in real time.",
  },
  {
    icon: ClipboardList,
    title: "Stock usage management",
    description: "Track how inventory is used across treatments, procedures, and daily operations.",
  },
  {
    icon: Warehouse,
    title: "Centralized inventory dashboard",
    description: "View and manage all clinic inventory from one organized dashboard.",
  },
  {
    icon: AlertTriangle,
    title: "Low stock alerts",
    description: "Receive alerts when items are running low so you can restock before shortages occur.",
  },
]
...
const FAQ_ITEMS = [
  {
    ...
    a: "Stock management helps clinics track medicines, supplies, and inventory used in daily operations.",
  },
  {
    q: "Can HealVare track clinic inventory?",
    a: "Yes. HealVare allows clinics to monitor stock levels and manage inventory in one centralized system.",
  },
  {
    q: "Does HealVare provide low stock alerts?",
    a: "Yes. Clinics receive alerts when inventory levels are low so they can restock in time.",
  },
  {
    q: "Can clinics track stock usage?",
    a: "Yes. HealVare tracks how inventory is used during treatments and daily clinic operations.",
  },
  {
    q: "Is stock management useful for multi-clinic practices?",
    a: "Yes. Clinics can track and manage inventory across multiple locations.",
  },
]
...
>
            ...
            <motion.p
              ...
              variants={fadeUp}
            >
         Manage clinic inventory efficiently with real-time stock tracking and automated alerts.
            </motion.p>
            ...
            <motion.p
              ...
              variants={fadeUp}
            >
HealVare Stock Management helps clinics track inventory, monitor usage, and avoid stock shortages with intelligent alerts.            </motion.p>
        ...
        <div className="mx-auto max-w-6xl">
          <ScrollReveal>
            <h2 className="text-3xl font-semibold text-center text-gray-900">
              Manage your clinic inventory efficiently
            </h2>
          </ScrollReveal>
          <ScrollReveal delay={0.08}>
            <p className="text-center text-gray-600 mt-4 max-w-2xl mx-auto">
Track inventory levels, manage supplies, and ensure your clinic always has the resources it needs.            </p>
          </ScrollReveal>
...
heading="Monitor stock levels"
body="Keep track of medicines, supplies, and clinic inventory with a centralized stock management system."
bullets={[
...
heading="Prevent shortages with alerts"
body="Receive notifications when stock levels drop so your clinic never runs out of essential supplies."
bullets={[
  "Automatic low stock alerts",
  "Plan timely restocking",
      ...
      <section className="py-20 px-6">
        ...
        >
          <motion.h2
            ...
            variants={fadeUp}
          >
            Ready to manage your clinic inventory?
          </motion.h2>
          <motion.p className="mt-4 text-gray-600" variants={fadeUp}>
       See how HealVare Stock Management helps clinics track inventory and avoid supply shortages.
          </motion.p>
