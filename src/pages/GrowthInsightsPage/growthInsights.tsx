...
const FEATURES = [
  {
    ...
    description: "Track clinic performance with real-time dashboards and visual reports.",
  },
  {
    icon: TrendingUp,
    title: "Revenue insights",
    description: "Understand revenue trends, billing performance, and financial growth.",
  },
  {
    icon: PieChart,
    title: "Operational metrics",
    description: "Analyze appointments, patient flow, and staff productivity in one place.",
  },
  {
    icon: FileText,
    title: "Custom reports",
    description: "Generate and export detailed reports for management, finance, and planning.",
  },
]
const FAQ_ITEMS = [
  {
    q: "What are practice reports?",
    a: "Practice reports provide insights into clinic performance including revenue, patient activity, and operational efficiency.",
  },
  {
    q: "Can HealVare generate financial reports?",
    a: "Yes. HealVare provides revenue summaries, billing reports, and financial performance insights for clinics.",
  },
  {
    q: "Can reports be exported?",
    a: "Yes. Reports can be exported and shared with management teams for analysis and decision making.",
  },
  {
    q: "Are reports updated in real time?",
    a: "Yes. Practice reports are updated automatically as new clinic data is recorded.",
  },
  {
    q: "Can clinic managers access performance insights?",
    a: "Yes. Authorized users can access dashboards and reports to monitor clinic performance.",
  },
]
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <motion.h1
              ...
              variants={fadeUp}
            >
             Understand Your Clinic Performance
            </motion.h1>
            ...
            <motion.p
              ...
              variants={fadeUp}
            >
         Track revenue, patient activity, and operational performance in one place.
            </motion.p>
            ...
            <motion.p
              ...
              variants={fadeUp}
            >
           HealVare Practice Reports gives clinics powerful analytics and insights to support smarter business decisions.
            </motion.p>
          ...
          >
            ...
            >
              <img
                ...
                className="w-full h-full object-cover object-top min-h"
              />
            </motion.div>
          </motion.div>
        </div>
        ...
        <div className="mx-auto max-w-6xl">
          <ScrollReveal>
            <h2 className="text-3xl font-semibold text-center text-gray-900">
              Built for powerful clinic insights
            </h2>
          </ScrollReveal>
          <ScrollReveal delay={0.08}>
            <p className="text-center text-gray-600 mt-4 max-w-2xl mx-auto">
              Everything you need to analyze clinic performance, revenue, and operational efficiency.
            </p>
          </ScrollReveal>
...
<DeepDiveRow
  ...
  heading="Understand your clinic performance"
  body="Track key performance metrics including patient visits, revenue trends, and operational activity."
  bullets={[
...
<DeepDiveRow
  ...
  heading="Make smarter clinic decisions"
  body="Use clear analytics and reports to improve clinic efficiency and drive better outcomes."
  bullets={[
    "Customizable clinic reports",
      ...
      <section className="py-20 px-6">
        ...
        >
          <motion.h2
            ...
            variants={fadeUp}
          >
            Ready to unlock powerful clinic insights?
          </motion.h2>
          <motion.p className="mt-4 text-gray-600" variants={fadeUp}>
       See how HealVare Practice Reports helps clinics track performance and make data-driven decisions.
          </motion.p>
